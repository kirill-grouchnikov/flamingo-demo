 ...
 */
public class ext_mp2 implements
...
((GeneralPath)shape).lineTo(25.000002, 91.200005);
((GeneralPath)shape).lineTo(25.000002, 75.5);
((GeneralPath)shape).lineTo(21.000002, 91.2);
((GeneralPath)shape).lineTo(17.100002, 91.2);
((GeneralPath)shape).lineTo(13.100002, 75.5);
((GeneralPath)shape).lineTo(13.100002, 91.2);
...
((GeneralPath)shape).lineTo(37.000004, 83.70001);
((GeneralPath)shape).lineTo(37.000004, 91.20001);
...
((GeneralPath)shape).lineTo(36.9, 74.59999);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(63.8, 87.6);
((GeneralPath)shape).lineTo(63.8, 91.1);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_mp2 of(int width, int height) {
       ext_mp2 result = new ext_mp2();
       result.width = width;

 ...
 */
public class ext_mdb implements
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(33.9, 74.6);
((GeneralPath)shape).lineTo(33.9, 87.7);
((GeneralPath)shape).lineTo(36.9, 87.7);
((GeneralPath)shape).curveTo(38.0, 87.7, 38.9, 87.6, 39.4, 87.5);
((GeneralPath)shape).curveTo(40.100002, 87.3, 40.600002, 87.1, 41.0, 86.7);
((GeneralPath)shape).curveTo(41.399998, 86.299995, 41.8, 85.7, 42.1, 84.799995);
((GeneralPath)shape).curveTo(42.399998, 83.899994, 42.5, 82.7, 42.5, 81.2);
((GeneralPath)shape).curveTo(42.5, 79.7, 42.4, 78.5, 42.1, 77.7);
((GeneralPath)shape).curveTo(41.799995, 76.899994, 41.399998, 76.2, 40.899998, 75.799995);
((GeneralPath)shape).curveTo(40.399998, 75.299995, 39.8, 74.99999, 38.999996, 74.899994);
((GeneralPath)shape).curveTo(38.399998, 74.799995, 37.299995, 74.7, 35.699997, 74.7);
((GeneralPath)shape).lineTo(33.9, 74.7);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(50.2, 71.2);
((GeneralPath)shape).lineTo(58.300003, 71.2);
((GeneralPath)shape).curveTo(59.9, 71.2, 61.100002, 71.299995, 61.9, 71.399994);
((GeneralPath)shape).curveTo(62.7, 71.49999, 63.4, 71.799995, 64.0, 72.2);
((GeneralPath)shape).curveTo(64.6, 72.6, 65.1, 73.2, 65.5, 73.899994);
((GeneralPath)shape).curveTo(65.9, 74.59999, 66.1, 75.399994, 66.1, 76.2);
((GeneralPath)shape).curveTo(66.1, 77.1, 65.799995, 78.0, 65.299995, 78.799995);
((GeneralPath)shape).curveTo(64.799995, 79.6, 64.1, 80.2, 63.199997, 80.49999);
((GeneralPath)shape).curveTo(64.399994, 80.899994, 65.399994, 81.49999, 66.0, 82.299995);
((GeneralPath)shape).curveTo(66.7, 83.1, 67.0, 84.1, 67.0, 85.299995);
((GeneralPath)shape).curveTo(67.0, 86.2, 66.8, 87.1, 66.4, 87.899994);
((GeneralPath)shape).curveTo(66.0, 88.69999, 65.4, 89.399994, 64.700005, 89.899994);
((GeneralPath)shape).curveTo(64.00001, 90.399994, 63.0, 90.8, 62.0, 90.9);
((GeneralPath)shape).curveTo(61.3, 91.0, 59.6, 91.0, 57.0, 91.1);
((GeneralPath)shape).lineTo(50.1, 91.1);
((GeneralPath)shape).lineTo(50.1, 71.2);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(54.3, 74.5);
((GeneralPath)shape).lineTo(54.3, 79.1);
...
((GeneralPath)shape).lineTo(54.3, 74.50001);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(54.3, 82.4);
((GeneralPath)shape).lineTo(54.3, 87.700005);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_mdb of(int width, int height) {
       ext_mdb result = new ext_mdb();
       result.width = width;

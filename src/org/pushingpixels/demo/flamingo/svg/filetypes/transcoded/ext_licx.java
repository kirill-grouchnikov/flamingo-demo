 ...
 */
public class ext_licx implements
...
((GeneralPath)shape).curveTo(41.7, 86.100006, 42.2, 85.2, 42.5, 84.0);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(46.7, 89.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_licx of(int width, int height) {
       ext_licx result = new ext_licx();
       result.width = width;

 ...
 */
public class ext_pptm implements
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(9.6, 78.2);
((GeneralPath)shape).lineTo(9.6, 82.7);
((GeneralPath)shape).lineTo(11.400001, 82.7);
((GeneralPath)shape).curveTo(12.700001, 82.7, 13.5, 82.6, 13.900001, 82.5);
((GeneralPath)shape).curveTo(14.3, 82.3, 14.700001, 82.1, 14.900001, 81.7);
((GeneralPath)shape).curveTo(15.1, 81.299995, 15.3, 80.899994, 15.3, 80.5);
((GeneralPath)shape).curveTo(15.3, 79.9, 15.1, 79.5, 14.8, 79.1);
((GeneralPath)shape).curveTo(14.5, 78.7, 14.0, 78.5, 13.5, 78.4);
((GeneralPath)shape).curveTo(13.1, 78.3, 12.4, 78.3, 11.2, 78.3);
((GeneralPath)shape).lineTo(9.6, 78.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(21.2, 91.19999);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(24.4, 78.2);
((GeneralPath)shape).lineTo(24.4, 82.7);
((GeneralPath)shape).lineTo(26.199999, 82.7);
((GeneralPath)shape).curveTo(27.499998, 82.7, 28.3, 82.6, 28.699999, 82.5);
((GeneralPath)shape).curveTo(29.099998, 82.3, 29.499998, 82.1, 29.699999, 81.7);
((GeneralPath)shape).curveTo(29.9, 81.299995, 30.099998, 80.899994, 30.099998, 80.5);
((GeneralPath)shape).curveTo(30.099998, 79.9, 29.899998, 79.5, 29.599998, 79.1);
((GeneralPath)shape).curveTo(29.3, 78.7, 28.8, 78.5, 28.3, 78.4);
((GeneralPath)shape).curveTo(27.9, 78.3, 27.199999, 78.3, 26.0, 78.3);
((GeneralPath)shape).lineTo(24.4, 78.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(49.5, 91.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_pptm of(int width, int height) {
       ext_pptm result = new ext_pptm();
       result.width = width;

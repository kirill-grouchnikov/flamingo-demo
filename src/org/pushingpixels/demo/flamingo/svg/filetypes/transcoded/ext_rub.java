 ...
 */
public class ext_rub implements
...
((GeneralPath)shape).lineTo(26.999998, 89.99999);
((GeneralPath)shape).lineTo(22.099998, 89.99999);
((GeneralPath)shape).lineTo(19.199999, 85.69999);
((GeneralPath)shape).curveTo(18.199999, 84.19999, 17.4, 83.19999, 17.099998, 82.79999);
((GeneralPath)shape).curveTo(16.699999, 82.39999, 16.3, 82.09999, 15.899999, 81.999985);
((GeneralPath)shape).curveTo(15.499999, 81.89999, 14.799998, 81.79999, 13.899999, 81.79999);
((GeneralPath)shape).lineTo(13.0, 81.79999);
((GeneralPath)shape).lineTo(13.0, 90.09999);
((GeneralPath)shape).lineTo(8.9, 90.09999);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(63.999992, 78.6, 63.29999, 79.2, 62.399994, 79.49999);
...
((GeneralPath)shape).lineTo(53.5, 81.4);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_rub of(int width, int height) {
       ext_rub result = new ext_rub();
       result.width = width;

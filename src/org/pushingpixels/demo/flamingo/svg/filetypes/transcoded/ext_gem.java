 ...
 */
public class ext_gem implements
...
((GeneralPath)shape).curveTo(8.799999, 88.2, 7.7, 87.0, 6.8999996, 85.4);
((GeneralPath)shape).curveTo(6.0999994, 83.8, 5.7, 82.0, 5.7, 80.1);
...
((GeneralPath)shape).curveTo(10.600001, 76.09999, 10.000001, 77.799995, 10.000001, 79.899994);
((GeneralPath)shape).curveTo(10.000001, 82.299995, 10.500001, 83.99999, 11.600001, 85.2);
((GeneralPath)shape).curveTo(12.700002, 86.399994, 14.100001, 87.0, 15.800001, 87.0);
((GeneralPath)shape).curveTo(16.7, 87.0, 17.500002, 86.8, 18.400002, 86.5);
((GeneralPath)shape).curveTo(19.300001, 86.2, 20.000002, 85.8, 20.600002, 85.3);
((GeneralPath)shape).lineTo(20.600002, 82.8);
((GeneralPath)shape).lineTo(15.7, 82.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(76, 108, 123, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(28.2, 90.1);
...
((GeneralPath)shape).lineTo(43.5, 90.00001);
((GeneralPath)shape).lineTo(28.2, 90.00001);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(76, 108, 123, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(46.9, 90.1);
...
((GeneralPath)shape).lineTo(46.9, 90.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_gem of(int width, int height) {
       ext_gem result = new ext_gem();
       result.width = width;

 ...
 */
public class ext_gif implements
...
((GeneralPath)shape).curveTo(15.699999, 74.0, 16.9, 72.799995, 18.599998, 71.9);
...
((GeneralPath)shape).lineTo(23.6, 83.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(35.8, 91.1);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(43.7, 91.1);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_gif of(int width, int height) {
       ext_gif result = new ext_gif();
       result.width = width;

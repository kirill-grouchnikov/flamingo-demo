 ...
 */
public class ext_udf implements
...
((GeneralPath)shape).curveTo(15.0, 88.7, 15.8, 89.0, 17.0, 89.0);
...
((GeneralPath)shape).curveTo(22.800001, 90.8, 22.000002, 91.3, 21.000002, 91.700005);
((GeneralPath)shape).curveTo(20.000002, 92.100006, 18.700003, 92.3, 17.100002, 92.3);
((GeneralPath)shape).curveTo(15.200003, 92.3, 13.700003, 92.100006, 12.700003, 91.600006);
((GeneralPath)shape).curveTo(11.700003, 91.200005, 10.9000025, 90.600006, 10.4000025, 89.90001);
((GeneralPath)shape).curveTo(9.9000025, 89.20001, 9.4000025, 88.50001, 9.300002, 87.70001);
((GeneralPath)shape).curveTo(9.000002, 86.60001, 8.9000025, 84.90001, 8.9000025, 82.70001);
((GeneralPath)shape).lineTo(8.9000025, 72.2);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_udf of(int width, int height) {
       ext_udf result = new ext_udf();
       result.width = width;

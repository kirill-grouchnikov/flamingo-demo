 ...
 */
public class ext_xps implements
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(9.3, 91.5);
...
((GeneralPath)shape).lineTo(14.0, 91.5);
...
((GeneralPath)shape).lineTo(35.8, 72.2);
((GeneralPath)shape).curveTo(38.2, 72.2, 39.8, 72.299995, 40.5, 72.5);
((GeneralPath)shape).curveTo(41.6, 72.8, 42.6, 73.4, 43.3, 74.4);
((GeneralPath)shape).curveTo(44.1, 75.4, 44.399998, 76.6, 44.399998, 78.200005);
((GeneralPath)shape).curveTo(44.399998, 79.4, 44.199997, 80.4, 43.699997, 81.200005);
((GeneralPath)shape).curveTo(43.299995, 82.00001, 42.699997, 82.600006, 41.999996, 83.100006);
((GeneralPath)shape).curveTo(41.299995, 83.600006, 40.599995, 83.90001, 39.999996, 84.00001);
((GeneralPath)shape).curveTo(39.099995, 84.200005, 37.699997, 84.30001, 35.899998, 84.30001);
((GeneralPath)shape).lineTo(33.3, 84.30001);
((GeneralPath)shape).lineTo(33.3, 91.60001);
((GeneralPath)shape).lineTo(29.5, 91.60001);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(33.4, 75.5);
((GeneralPath)shape).lineTo(33.4, 81.0);
((GeneralPath)shape).lineTo(35.600002, 81.0);
((GeneralPath)shape).curveTo(37.2, 81.0, 38.2, 80.9, 38.7, 80.7);
((GeneralPath)shape).curveTo(39.2, 80.5, 39.600002, 80.2, 39.9, 79.799995);
((GeneralPath)shape).curveTo(40.2, 79.399994, 40.300003, 78.899994, 40.300003, 78.299995);
((GeneralPath)shape).curveTo(40.300003, 77.6, 40.100002, 76.99999, 39.700005, 76.6);
((GeneralPath)shape).curveTo(39.300003, 76.1, 38.800003, 75.9, 38.100006, 75.7);
((GeneralPath)shape).curveTo(37.600006, 75.6, 36.700005, 75.6, 35.300007, 75.6);
((GeneralPath)shape).lineTo(33.4, 75.6);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).curveTo(52.600002, 88.30001, 53.600002, 88.600006, 54.800003, 88.600006);
...
((GeneralPath)shape).curveTo(61.199997, 90.09999, 60.299995, 90.79999, 59.199997, 91.29999);
...
((GeneralPath)shape).curveTo(47.7, 89.1, 46.9, 87.4, 46.7, 85.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_xps of(int width, int height) {
       ext_xps result = new ext_xps();
       result.width = width;

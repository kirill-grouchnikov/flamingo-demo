...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(27.9, 92.2);
((GeneralPath)shape).lineTo(27.9, 88.6);
((GeneralPath)shape).lineTo(38.4, 75.7);
((GeneralPath)shape).lineTo(29.100002, 75.7);
((GeneralPath)shape).lineTo(29.100002, 72.299995);
((GeneralPath)shape).lineTo(43.700005, 72.299995);
((GeneralPath)shape).lineTo(43.700005, 75.399994);
((GeneralPath)shape).lineTo(32.8, 88.8);
((GeneralPath)shape).lineTo(44.1, 88.8);
((GeneralPath)shape).lineTo(44.1, 92.200005);
((GeneralPath)shape).lineTo(27.9, 92.200005);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_z of(int width, int height) {
       ext_z result = new ext_z();
       result.width = width;

 ...
 */
public class ext_cmd implements
...
((GeneralPath)shape).curveTo(17.899998, 86.3, 18.4, 85.2, 18.8, 83.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(76, 108, 123, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(49.4, 71.2);
((GeneralPath)shape).lineTo(56.800003, 71.2);
((GeneralPath)shape).curveTo(58.500004, 71.2, 59.700005, 71.299995, 60.600002, 71.6);
((GeneralPath)shape).curveTo(61.800003, 71.9, 62.800003, 72.6, 63.600002, 73.4);
((GeneralPath)shape).curveTo(64.4, 74.200005, 65.100006, 75.3, 65.5, 76.6);
((GeneralPath)shape).curveTo(65.9, 77.9, 66.2, 79.4, 66.2, 81.299995);
((GeneralPath)shape).curveTo(66.2, 82.899994, 66.0, 84.299995, 65.6, 85.49999);
((GeneralPath)shape).curveTo(65.1, 86.899994, 64.4, 88.09999, 63.5, 88.99999);
((GeneralPath)shape).curveTo(62.8, 89.69999, 61.9, 90.19999, 60.7, 90.59999);
((GeneralPath)shape).curveTo(59.8, 90.899994, 58.600002, 90.99999, 57.100002, 90.99999);
((GeneralPath)shape).lineTo(49.500004, 90.99999);
((GeneralPath)shape).lineTo(49.500004, 71.2);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(53.4, 74.6);
((GeneralPath)shape).lineTo(53.4, 87.7);
((GeneralPath)shape).lineTo(56.4, 87.7);
((GeneralPath)shape).curveTo(57.5, 87.7, 58.300003, 87.6, 58.800003, 87.5);
((GeneralPath)shape).curveTo(59.500004, 87.3, 60.000004, 87.1, 60.4, 86.7);
((GeneralPath)shape).curveTo(60.8, 86.299995, 61.2, 85.7, 61.5, 84.799995);
((GeneralPath)shape).curveTo(61.8, 83.899994, 61.9, 82.7, 61.9, 81.2);
((GeneralPath)shape).curveTo(61.9, 79.7, 61.800003, 78.5, 61.5, 77.7);
((GeneralPath)shape).curveTo(61.199997, 76.899994, 60.8, 76.2, 60.4, 75.799995);
((GeneralPath)shape).curveTo(59.9, 75.299995, 59.300003, 74.99999, 58.5, 74.899994);
((GeneralPath)shape).curveTo(57.9, 74.799995, 56.8, 74.7, 55.2, 74.7);
((GeneralPath)shape).lineTo(53.4, 74.7);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_cmd of(int width, int height) {
       ext_cmd result = new ext_cmd();
       result.width = width;

 ...
 */
public class ext_docx implements
...
((GeneralPath)shape).curveTo(12.3, 78.0, 11.4, 78.0, 10.1, 78.0);
((GeneralPath)shape).lineTo(8.6, 78.0);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).curveTo(21.5, 87.8, 20.8, 85.8, 20.8, 83.3);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(24.1, 83.2);
((GeneralPath)shape).curveTo(24.1, 85.0, 24.5, 86.299995, 25.300001, 87.299995);
((GeneralPath)shape).curveTo(26.1, 88.2, 27.2, 88.7, 28.500002, 88.7);
((GeneralPath)shape).curveTo(29.800001, 88.7, 30.800001, 88.2, 31.700003, 87.299995);
((GeneralPath)shape).curveTo(32.500004, 86.399994, 32.9, 84.99999, 32.9, 83.2);
((GeneralPath)shape).curveTo(32.9, 81.399994, 32.5, 80.0, 31.7, 79.2);
((GeneralPath)shape).curveTo(30.900002, 78.399994, 29.800001, 77.899994, 28.5, 77.899994);
((GeneralPath)shape).curveTo(27.2, 77.899994, 26.1, 78.299995, 25.3, 79.2);
((GeneralPath)shape).curveTo(24.5, 80.0, 24.1, 81.4, 24.1, 83.2);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(48.9, 85.3);
((GeneralPath)shape).lineTo(52.0, 86.3);
((GeneralPath)shape).curveTo(51.5, 88.0, 50.7, 89.3, 49.6, 90.100006);
((GeneralPath)shape).curveTo(48.5, 90.90001, 47.1, 91.40001, 45.399998, 91.40001);
((GeneralPath)shape).curveTo(43.3, 91.40001, 41.6, 90.70001, 40.199997, 89.30001);
((GeneralPath)shape).curveTo(38.799995, 87.90001, 38.199997, 85.90001, 38.199997, 83.40001);
((GeneralPath)shape).curveTo(38.199997, 80.80001, 38.899998, 78.70001, 40.299995, 77.30001);
((GeneralPath)shape).curveTo(41.699997, 75.90001, 43.499996, 75.10001, 45.699997, 75.10001);
((GeneralPath)shape).curveTo(47.6, 75.10001, 49.199997, 75.70001, 50.399998, 76.80001);
((GeneralPath)shape).curveTo(51.1, 77.50001, 51.699997, 78.40001, 51.999996, 79.70001);
((GeneralPath)shape).lineTo(48.799995, 80.500015);
((GeneralPath)shape).curveTo(48.599995, 79.70001, 48.199997, 79.000015, 47.599995, 78.60001);
((GeneralPath)shape).curveTo(46.999996, 78.10001, 46.299995, 77.90002, 45.399994, 77.90002);
((GeneralPath)shape).curveTo(44.199993, 77.90002, 43.299995, 78.30002, 42.499992, 79.20002);
((GeneralPath)shape).curveTo(41.79999, 80.00002, 41.399994, 81.40002, 41.399994, 83.30002);
((GeneralPath)shape).curveTo(41.399994, 85.30002, 41.799995, 86.70002, 42.499992, 87.60002);
((GeneralPath)shape).curveTo(43.19999, 88.50002, 44.199993, 88.900024, 45.29999, 88.900024);
((GeneralPath)shape).curveTo(46.199993, 88.900024, 46.89999, 88.60002, 47.499992, 88.10002);
((GeneralPath)shape).curveTo(48.2, 87.3, 48.7, 86.4, 48.9, 85.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(58.600002, 82.9);
((GeneralPath)shape).lineTo(53.7, 75.4);
((GeneralPath)shape).lineTo(57.5, 75.4);
((GeneralPath)shape).lineTo(60.7, 80.5);
((GeneralPath)shape).lineTo(63.8, 75.4);
((GeneralPath)shape).lineTo(67.5, 75.4);
((GeneralPath)shape).lineTo(62.5, 83.0);
((GeneralPath)shape).lineTo(67.9, 91.1);
((GeneralPath)shape).lineTo(64.0, 91.1);
((GeneralPath)shape).lineTo(60.5, 85.7);
((GeneralPath)shape).lineTo(57.0, 91.1);
((GeneralPath)shape).lineTo(53.2, 91.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_docx of(int width, int height) {
       ext_docx result = new ext_docx();
       result.width = width;

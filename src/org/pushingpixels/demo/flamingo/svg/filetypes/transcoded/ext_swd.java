 ...
 */
public class ext_swd implements
...
((GeneralPath)shape).curveTo(5.6, 88.5, 4.8, 86.8, 4.5, 84.6);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_swd of(int width, int height) {
       ext_swd result = new ext_swd();
       result.width = width;

 ...
 */
public class ext_epub implements
...
((GeneralPath)shape).lineTo(7.2, 91.6);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(55.8, 78.50001);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(55.8, 84.8);
...
((GeneralPath)shape).lineTo(55.8, 84.90001);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_epub of(int width, int height) {
       ext_epub result = new ext_epub();
       result.width = width;

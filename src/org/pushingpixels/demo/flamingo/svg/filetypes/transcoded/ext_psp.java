 ...
 */
public class ext_psp implements
...
((GeneralPath)shape).lineTo(10.6, 91.100006);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(29.2, 88.5, 28.4, 86.8, 28.2, 84.6);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(47.8, 91.1);
((GeneralPath)shape).lineTo(47.8, 71.2);
((GeneralPath)shape).lineTo(54.3, 71.2);
((GeneralPath)shape).curveTo(56.8, 71.2, 58.399998, 71.299995, 59.1, 71.5);
((GeneralPath)shape).curveTo(60.199997, 71.8, 61.199997, 72.4, 62.0, 73.4);
((GeneralPath)shape).curveTo(62.800003, 74.4, 63.2, 75.700005, 63.2, 77.3);
((GeneralPath)shape).curveTo(63.2, 78.5, 63.0, 79.5, 62.5, 80.4);
((GeneralPath)shape).curveTo(62.1, 81.200005, 61.5, 81.9, 60.8, 82.4);
((GeneralPath)shape).curveTo(60.1, 82.9, 59.399998, 83.200005, 58.7, 83.3);
((GeneralPath)shape).curveTo(57.7, 83.5, 56.3, 83.600006, 54.5, 83.600006);
((GeneralPath)shape).lineTo(51.9, 83.600006);
((GeneralPath)shape).lineTo(51.9, 91.100006);
((GeneralPath)shape).lineTo(47.8, 91.100006);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(51.8, 74.6);
((GeneralPath)shape).lineTo(51.8, 80.2);
...
((GeneralPath)shape).lineTo(51.8, 74.59999);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_psp of(int width, int height) {
       ext_psp result = new ext_psp();
       result.width = width;

 ...
 */
public class ext_bpg implements
...
((GeneralPath)shape).curveTo(22.400002, 79.6, 21.7, 80.2, 20.800001, 80.49999);
...
((GeneralPath)shape).curveTo(19.0, 91.0, 17.4, 91.0, 14.8, 91.1);
...
((GeneralPath)shape).lineTo(32.2, 74.59999);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_bpg of(int width, int height) {
       ext_bpg result = new ext_bpg();
       result.width = width;

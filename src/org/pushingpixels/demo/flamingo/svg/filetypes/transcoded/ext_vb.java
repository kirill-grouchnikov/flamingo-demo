 ...
 */
public class ext_vb implements
...
((GeneralPath)shape).lineTo(17.3, 69.8);
((GeneralPath)shape).lineTo(21.699999, 69.8);
((GeneralPath)shape).lineTo(26.8, 84.600006);
((GeneralPath)shape).lineTo(31.8, 69.8);
((GeneralPath)shape).lineTo(36.1, 69.8);
((GeneralPath)shape).lineTo(28.8, 89.8);
((GeneralPath)shape).lineTo(24.5, 89.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(76, 108, 123, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(38.2, 69.8);
((GeneralPath)shape).lineTo(46.300003, 69.8);
((GeneralPath)shape).curveTo(47.9, 69.8, 49.100002, 69.9, 49.9, 70.0);
((GeneralPath)shape).curveTo(50.7, 70.1, 51.4, 70.4, 52.0, 70.8);
((GeneralPath)shape).curveTo(52.6, 71.200005, 53.1, 71.8, 53.6, 72.5);
((GeneralPath)shape).curveTo(54.1, 73.2, 54.199997, 74.0, 54.199997, 74.8);
((GeneralPath)shape).curveTo(54.199997, 75.700005, 53.899998, 76.600006, 53.399998, 77.4);
((GeneralPath)shape).curveTo(52.899998, 78.200005, 52.199997, 78.8, 51.3, 79.200005);
((GeneralPath)shape).curveTo(52.5, 79.600006, 53.5, 80.200005, 54.1, 81.00001);
((GeneralPath)shape).curveTo(54.8, 81.90001, 55.1, 82.90001, 55.1, 84.00001);
((GeneralPath)shape).curveTo(55.1, 84.90001, 54.899998, 85.80001, 54.5, 86.700005);
((GeneralPath)shape).curveTo(54.100002, 87.6, 53.5, 88.200005, 52.7, 88.8);
((GeneralPath)shape).curveTo(52.0, 89.3, 51.0, 89.600006, 50.0, 89.8);
((GeneralPath)shape).curveTo(49.3, 89.9, 47.7, 89.9, 45.1, 89.9);
((GeneralPath)shape).lineTo(38.199997, 89.9);
((GeneralPath)shape).lineTo(38.199997, 69.8);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(42.3, 73.1);
((GeneralPath)shape).lineTo(42.3, 77.7);
((GeneralPath)shape).lineTo(45.0, 77.7);
((GeneralPath)shape).curveTo(46.6, 77.7, 47.6, 77.7, 48.0, 77.6);
((GeneralPath)shape).curveTo(48.7, 77.5, 49.2, 77.299995, 49.7, 76.9);
((GeneralPath)shape).curveTo(50.100002, 76.5, 50.3, 76.0, 50.3, 75.3);
((GeneralPath)shape).curveTo(50.3, 74.700005, 50.1, 74.200005, 49.8, 73.8);
((GeneralPath)shape).curveTo(49.5, 73.4, 48.899998, 73.200005, 48.3, 73.100006);
((GeneralPath)shape).curveTo(47.899998, 73.100006, 46.7, 73.00001, 44.8, 73.00001);
((GeneralPath)shape).lineTo(42.3, 73.00001);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(42.3, 81.1);
((GeneralPath)shape).lineTo(42.3, 86.5);
((GeneralPath)shape).lineTo(46.1, 86.5);
((GeneralPath)shape).curveTo(47.6, 86.5, 48.5, 86.5, 48.899998, 86.4);
((GeneralPath)shape).curveTo(49.499996, 86.3, 49.999996, 86.0, 50.399998, 85.6);
((GeneralPath)shape).curveTo(50.8, 85.2, 50.999996, 84.6, 50.999996, 83.9);
((GeneralPath)shape).curveTo(50.999996, 83.3, 50.899998, 82.8, 50.599995, 82.4);
((GeneralPath)shape).curveTo(50.29999, 82.0, 49.899994, 81.700005, 49.299995, 81.5);
((GeneralPath)shape).curveTo(48.699997, 81.3, 47.499996, 81.2, 45.699997, 81.2);
((GeneralPath)shape).lineTo(42.3, 81.2);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_vb of(int width, int height) {
       ext_vb result = new ext_vb();
       result.width = width;

 ...
 */
public class ext_folder implements
...
((GeneralPath)shape).lineTo(70.99999, 11.699997);
((GeneralPath)shape).curveTo(70.99999, 10.799997, 70.299995, 9.999997, 69.299995, 9.999997);
((GeneralPath)shape).lineTo(44.299995, 9.999997);
((GeneralPath)shape).lineTo(37.599995, 14.999997);
((GeneralPath)shape).lineTo(2.5999947, 14.999997);
((GeneralPath)shape).curveTo(1.6999947, 14.999997, 0.8999946, 15.799997, 0.8999946, 16.699997);
((GeneralPath)shape).lineTo(2.5999947, 52.6);
((GeneralPath)shape).curveTo(2.7, 53.5, 3.4, 54.3, 4.3, 54.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
paint = new Color(67, 66, 66, 255);
...
((GeneralPath)shape).curveTo(5.8999996, 4.9000006, 6.7, 4.1, 7.6, 4.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
paint = new Color(67, 66, 66, 255);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_folder of(int width, int height) {
       ext_folder result = new ext_folder();
       result.width = width;

 ...
 */
public class ext_eps implements
...
((GeneralPath)shape).lineTo(25.8, 91.00001);
((GeneralPath)shape).lineTo(10.4, 91.00001);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(29.2, 91.1);
((GeneralPath)shape).lineTo(29.2, 71.2);
((GeneralPath)shape).lineTo(35.7, 71.2);
((GeneralPath)shape).curveTo(38.2, 71.2, 39.8, 71.299995, 40.5, 71.5);
((GeneralPath)shape).curveTo(41.7, 71.8, 42.6, 72.4, 43.4, 73.4);
((GeneralPath)shape).curveTo(44.200005, 74.4, 44.600002, 75.700005, 44.600002, 77.3);
((GeneralPath)shape).curveTo(44.600002, 78.5, 44.4, 79.5, 43.9, 80.4);
((GeneralPath)shape).curveTo(43.4, 81.200005, 42.9, 81.9, 42.2, 82.4);
((GeneralPath)shape).curveTo(41.5, 82.9, 40.8, 83.200005, 40.100002, 83.3);
((GeneralPath)shape).curveTo(39.100002, 83.5, 37.7, 83.600006, 35.9, 83.600006);
((GeneralPath)shape).lineTo(33.2, 83.600006);
((GeneralPath)shape).lineTo(33.2, 91.100006);
((GeneralPath)shape).lineTo(29.2, 91.100006);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(33.3, 74.59999);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).curveTo(48.1, 88.5, 47.3, 86.8, 47.0, 84.6);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_eps of(int width, int height) {
       ext_eps result = new ext_eps();
       result.width = width;

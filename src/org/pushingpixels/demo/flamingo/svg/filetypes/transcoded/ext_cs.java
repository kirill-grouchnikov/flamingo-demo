 ...
 */
public class ext_cs implements
...
((GeneralPath)shape).curveTo(30.499994, 84.89999, 30.9, 83.9, 31.3, 82.4);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).curveTo(38.800003, 86.89998, 38.0, 85.5, 37.7, 83.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_cs of(int width, int height) {
       ext_cs result = new ext_cs();
       result.width = width;

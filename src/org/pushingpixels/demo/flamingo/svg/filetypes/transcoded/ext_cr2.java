 ...
 */
public class ext_cr2 implements
...
((GeneralPath)shape).curveTo(21.899996, 86.4, 22.4, 85.2, 22.7, 83.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).curveTo(37.900005, 83.39999, 37.4, 83.2, 37.0, 83.0);
((GeneralPath)shape).curveTo(36.6, 82.9, 35.9, 82.8, 35.0, 82.8);
((GeneralPath)shape).lineTo(34.2, 82.8);
((GeneralPath)shape).lineTo(34.2, 91.100006);
((GeneralPath)shape).lineTo(30.1, 91.100006);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(34.1, 79.6);
((GeneralPath)shape).lineTo(37.1, 79.6);
((GeneralPath)shape).curveTo(39.0, 79.6, 40.199997, 79.5, 40.699997, 79.4);
((GeneralPath)shape).curveTo(41.199997, 79.200005, 41.6, 79.0, 41.799995, 78.6);
((GeneralPath)shape).curveTo(42.099995, 78.2, 42.199997, 77.7, 42.199997, 77.1);
((GeneralPath)shape).curveTo(42.199997, 76.4, 41.999996, 75.9, 41.699997, 75.5);
((GeneralPath)shape).curveTo(41.299995, 75.1, 40.799995, 74.8, 40.199997, 74.7);
((GeneralPath)shape).curveTo(39.899998, 74.7, 38.899998, 74.6, 37.299995, 74.6);
((GeneralPath)shape).lineTo(34.199997, 74.6);
((GeneralPath)shape).lineTo(34.199997, 79.6);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(62.3, 87.5);
...
((GeneralPath)shape).lineTo(49.3, 77.0);
((GeneralPath)shape).curveTo(49.5, 74.9, 50.2, 73.4, 51.399998, 72.5);
((GeneralPath)shape).curveTo(52.6, 71.6, 54.1, 71.1, 55.899998, 71.1);
((GeneralPath)shape).curveTo(57.899998, 71.1, 59.399998, 71.6, 60.499996, 72.7);
((GeneralPath)shape).curveTo(61.599995, 73.799995, 62.199997, 75.1, 62.199997, 76.6);
((GeneralPath)shape).curveTo(62.199997, 77.5, 61.999996, 78.299995, 61.699997, 79.2);
((GeneralPath)shape).curveTo(61.399998, 80.0, 60.899998, 80.899994, 60.199997, 81.7);
((GeneralPath)shape).curveTo(59.699997, 82.299995, 58.899998, 83.1, 57.699997, 84.2);
((GeneralPath)shape).curveTo(56.499996, 85.299995, 55.699997, 86.0, 55.399998, 86.399994);
((GeneralPath)shape).curveTo(55.1, 86.799995, 54.8, 87.09999, 54.6, 87.49999);
((GeneralPath)shape).lineTo(62.3, 87.49999);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_cr2 of(int width, int height) {
       ext_cr2 result = new ext_cr2();
       result.width = width;

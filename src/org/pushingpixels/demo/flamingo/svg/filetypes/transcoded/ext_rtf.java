 ...
 */
public class ext_rtf implements
...
((GeneralPath)shape).lineTo(11.6, 91.2);
((GeneralPath)shape).closePath();
...
paint = new Color(76, 108, 123, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(36.3, 91.1);
((GeneralPath)shape).lineTo(36.3, 74.6);
((GeneralPath)shape).lineTo(30.4, 74.6);
((GeneralPath)shape).lineTo(30.4, 71.2);
((GeneralPath)shape).lineTo(46.3, 71.2);
((GeneralPath)shape).lineTo(46.3, 74.6);
((GeneralPath)shape).lineTo(40.399998, 74.6);
((GeneralPath)shape).lineTo(40.399998, 91.1);
((GeneralPath)shape).lineTo(36.3, 91.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_rtf of(int width, int height) {
       ext_rtf result = new ext_rtf();
       result.width = width;

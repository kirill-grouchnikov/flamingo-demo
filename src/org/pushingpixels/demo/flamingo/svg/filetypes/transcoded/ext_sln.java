 ...
 */
public class ext_sln implements
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(9.7, 83.3);
((GeneralPath)shape).lineTo(13.7, 82.9);
((GeneralPath)shape).curveTo(13.9, 84.200005, 14.4, 85.200005, 15.2, 85.8);
((GeneralPath)shape).curveTo(15.9, 86.4, 16.9, 86.700005, 18.2, 86.700005);
((GeneralPath)shape).curveTo(19.5, 86.700005, 20.5, 86.4, 21.2, 85.9);
((GeneralPath)shape).curveTo(21.900002, 85.4, 22.2, 84.700005, 22.2, 84.0);
((GeneralPath)shape).curveTo(22.2, 83.5, 22.1, 83.1, 21.800001, 82.8);
((GeneralPath)shape).curveTo(21.500002, 82.50001, 21.000002, 82.200005, 20.300001, 81.9);
((GeneralPath)shape).curveTo(19.800001, 81.700005, 18.7, 81.4, 17.000002, 81.0);
((GeneralPath)shape).curveTo(14.800002, 80.5, 13.300002, 79.8, 12.400002, 79.0);
((GeneralPath)shape).curveTo(11.200002, 77.9, 10.500002, 76.6, 10.500002, 75.0);
((GeneralPath)shape).curveTo(10.500002, 74.0, 10.800002, 73.0, 11.400002, 72.1);
((GeneralPath)shape).curveTo(12.000001, 71.2, 12.800001, 70.5, 13.900002, 70.1);
((GeneralPath)shape).curveTo(15.000002, 69.7, 16.300001, 69.4, 17.900002, 69.4);
((GeneralPath)shape).curveTo(20.400002, 69.4, 22.400002, 70.0, 23.600002, 71.1);
((GeneralPath)shape).curveTo(24.800003, 72.2, 25.600002, 73.7, 25.600002, 75.5);
((GeneralPath)shape).lineTo(21.500002, 75.7);
((GeneralPath)shape).curveTo(21.300001, 74.7, 20.900002, 73.899994, 20.400002, 73.5);
((GeneralPath)shape).curveTo(19.800001, 73.0, 19.000002, 72.8, 17.800001, 72.8);
((GeneralPath)shape).curveTo(16.6, 72.8, 15.700001, 73.0, 15.000001, 73.5);
((GeneralPath)shape).curveTo(14.600001, 73.8, 14.400001, 74.2, 14.400001, 74.7);
((GeneralPath)shape).curveTo(14.400001, 75.2, 14.6, 75.6, 15.000001, 75.899994);
((GeneralPath)shape).curveTo(15.500001, 76.299995, 16.800001, 76.799995, 18.800001, 77.2);
((GeneralPath)shape).curveTo(20.800001, 77.7, 22.300001, 78.1, 23.2, 78.6);
((GeneralPath)shape).curveTo(24.1, 79.1, 24.900002, 79.799995, 25.400002, 80.6);
((GeneralPath)shape).curveTo(25.900002, 81.4, 26.2, 82.5, 26.2, 83.799995);
((GeneralPath)shape).curveTo(26.2, 84.899994, 25.900002, 85.99999, 25.2, 86.99999);
((GeneralPath)shape).curveTo(24.6, 87.99999, 23.6, 88.69999, 22.5, 89.19999);
((GeneralPath)shape).curveTo(21.4, 89.69999, 19.9, 89.89999, 18.1, 89.89999);
((GeneralPath)shape).curveTo(15.5, 89.89999, 13.6, 89.29999, 12.200001, 88.09998);
((GeneralPath)shape).curveTo(10.800001, 86.89998, 9.9, 85.5, 9.7, 83.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(76, 108, 123, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(29.7, 89.8);
((GeneralPath)shape).lineTo(29.7, 69.9);
((GeneralPath)shape).lineTo(33.8, 69.9);
((GeneralPath)shape).lineTo(33.8, 86.4);
((GeneralPath)shape).lineTo(44.0, 86.4);
((GeneralPath)shape).lineTo(44.0, 89.8);
((GeneralPath)shape).lineTo(29.7, 89.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(46.9, 69.8);
((GeneralPath)shape).lineTo(50.9, 69.8);
((GeneralPath)shape).lineTo(59.2, 83.200005);
((GeneralPath)shape).lineTo(59.2, 69.8);
((GeneralPath)shape).lineTo(63.0, 69.8);
((GeneralPath)shape).lineTo(63.0, 89.8);
((GeneralPath)shape).lineTo(58.9, 89.8);
((GeneralPath)shape).lineTo(50.7, 76.700005);
((GeneralPath)shape).lineTo(50.7, 89.8);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_sln of(int width, int height) {
       ext_sln result = new ext_sln();
       result.width = width;

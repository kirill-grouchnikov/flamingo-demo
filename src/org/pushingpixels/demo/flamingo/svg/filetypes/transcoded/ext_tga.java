 ...
 */
public class ext_tga implements
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(35.2, 83.8);
((GeneralPath)shape).lineTo(35.2, 80.5);
((GeneralPath)shape).lineTo(43.9, 80.5);
((GeneralPath)shape).lineTo(43.9, 88.4);
((GeneralPath)shape).curveTo(43.100002, 89.200005, 41.800003, 89.9, 40.2, 90.5);
((GeneralPath)shape).curveTo(38.6, 91.1, 37.0, 91.4, 35.3, 91.4);
((GeneralPath)shape).curveTo(33.2, 91.4, 31.4, 91.0, 29.8, 90.1);
((GeneralPath)shape).curveTo(28.199999, 89.2, 27.099998, 88.0, 26.3, 86.4);
((GeneralPath)shape).curveTo(25.5, 84.8, 25.099998, 83.0, 25.099998, 81.1);
((GeneralPath)shape).curveTo(25.099998, 79.0, 25.499998, 77.2, 26.399998, 75.6);
((GeneralPath)shape).curveTo(27.299997, 74.0, 28.499998, 72.799995, 30.199997, 71.9);
((GeneralPath)shape).curveTo(31.499996, 71.200005, 33.1, 70.9, 34.999996, 70.9);
((GeneralPath)shape).curveTo(37.499996, 70.9, 39.399998, 71.4, 40.799995, 72.4);
((GeneralPath)shape).curveTo(42.199997, 73.4, 43.099995, 74.9, 43.499996, 76.700005);
((GeneralPath)shape).lineTo(39.499996, 77.4);
((GeneralPath)shape).curveTo(39.199997, 76.4, 38.699997, 75.700005, 37.899998, 75.1);
((GeneralPath)shape).curveTo(37.1, 74.5, 36.199997, 74.299995, 34.999996, 74.299995);
((GeneralPath)shape).curveTo(33.199997, 74.299995, 31.799995, 74.899994, 30.799995, 75.99999);
((GeneralPath)shape).curveTo(29.799995, 77.09999, 29.199995, 78.799995, 29.199995, 80.899994);
((GeneralPath)shape).curveTo(29.199995, 83.299995, 29.699995, 84.99999, 30.799995, 86.2);
((GeneralPath)shape).curveTo(31.899996, 87.399994, 33.199997, 88.0, 34.899994, 88.0);
((GeneralPath)shape).curveTo(35.699993, 88.0, 36.599995, 87.8, 37.399994, 87.5);
((GeneralPath)shape).curveTo(38.199993, 87.2, 38.999992, 86.8, 39.599995, 86.3);
((GeneralPath)shape).lineTo(39.599995, 83.8);
((GeneralPath)shape).lineTo(35.2, 83.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(65.6, 91.1);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(58.2, 83.2);
((GeneralPath)shape).lineTo(55.4, 75.799995);
((GeneralPath)shape).lineTo(52.7, 83.2);
((GeneralPath)shape).lineTo(58.2, 83.2);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_tga of(int width, int height) {
       ext_tga result = new ext_tga();
       result.width = width;

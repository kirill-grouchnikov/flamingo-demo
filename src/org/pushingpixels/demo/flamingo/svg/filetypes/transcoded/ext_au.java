 ...
 */
public class ext_au implements
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(36.2, 91.2);
((GeneralPath)shape).lineTo(31.800001, 91.2);
((GeneralPath)shape).lineTo(30.0, 86.6);
((GeneralPath)shape).lineTo(22.0, 86.6);
((GeneralPath)shape).lineTo(20.3, 91.1);
((GeneralPath)shape).lineTo(16.0, 91.1);
((GeneralPath)shape).lineTo(23.8, 71.2);
((GeneralPath)shape).lineTo(28.099998, 71.2);
((GeneralPath)shape).lineTo(36.2, 91.2);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(28.7, 83.3);
((GeneralPath)shape).lineTo(26.0, 75.9);
((GeneralPath)shape).lineTo(23.3, 83.3);
((GeneralPath)shape).lineTo(28.7, 83.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(38.3, 71.3);
((GeneralPath)shape).lineTo(42.399998, 71.3);
((GeneralPath)shape).lineTo(42.399998, 82.0);
((GeneralPath)shape).curveTo(42.399998, 83.7, 42.399998, 84.8, 42.6, 85.3);
((GeneralPath)shape).curveTo(42.8, 86.100006, 43.199997, 86.8, 43.8, 87.3);
((GeneralPath)shape).curveTo(44.5, 87.8, 45.3, 88.0, 46.5, 88.0);
((GeneralPath)shape).curveTo(47.7, 88.0, 48.5, 87.8, 49.1, 87.3);
((GeneralPath)shape).curveTo(49.699997, 86.8, 50.0, 86.3, 50.199997, 85.600006);
((GeneralPath)shape).curveTo(50.299995, 84.90001, 50.399998, 83.8, 50.399998, 82.200005);
((GeneralPath)shape).lineTo(50.399998, 71.200005);
((GeneralPath)shape).lineTo(54.499996, 71.200005);
((GeneralPath)shape).lineTo(54.499996, 81.600006);
((GeneralPath)shape).curveTo(54.499996, 84.00001, 54.399998, 85.700005, 54.199997, 86.700005);
((GeneralPath)shape).curveTo(53.999996, 87.700005, 53.6, 88.50001, 52.999996, 89.200005);
((GeneralPath)shape).curveTo(52.399994, 89.9, 51.599995, 90.4, 50.599995, 90.8);
((GeneralPath)shape).curveTo(49.599995, 91.200005, 48.299995, 91.4, 46.699993, 91.4);
((GeneralPath)shape).curveTo(44.79999, 91.4, 43.29999, 91.200005, 42.29999, 90.700005);
((GeneralPath)shape).curveTo(41.29999, 90.3, 40.499992, 89.700005, 39.89999, 89.00001);
((GeneralPath)shape).curveTo(39.299988, 88.30001, 38.89999, 87.600006, 38.79999, 86.80001);
((GeneralPath)shape).curveTo(38.499992, 85.70001, 38.39999, 84.00001, 38.39999, 81.80001);
((GeneralPath)shape).lineTo(38.39999, 71.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_au of(int width, int height) {
       ext_au result = new ext_au();
       result.width = width;

 ...
 */
public class ext_aspx implements
...
((GeneralPath)shape).lineTo(21.9, 89.8);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(32.0, 84.0, 31.6, 83.8, 31.0, 83.6);
((GeneralPath)shape).curveTo(30.6, 83.5, 29.8, 83.2, 28.4, 82.9);
((GeneralPath)shape).curveTo(26.699999, 82.5, 25.5, 82.0, 24.8, 81.3);
((GeneralPath)shape).curveTo(23.8, 80.4, 23.3, 79.4, 23.3, 78.100006);
((GeneralPath)shape).curveTo(23.3, 77.3, 23.5, 76.50001, 24.0, 75.90001);
((GeneralPath)shape).curveTo(24.5, 75.20001, 25.1, 74.70001, 26.0, 74.30001);
((GeneralPath)shape).curveTo(26.9, 73.90001, 27.9, 73.80001, 29.1, 73.80001);
((GeneralPath)shape).curveTo(31.1, 73.80001, 32.6, 74.20001, 33.6, 75.10001);
((GeneralPath)shape).curveTo(34.6, 76.000015, 35.1, 77.10001, 35.199997, 78.60001);
((GeneralPath)shape).lineTo(32.0, 78.7);
((GeneralPath)shape).curveTo(31.9, 77.899994, 31.6, 77.299995, 31.1, 77.0);
((GeneralPath)shape).curveTo(30.6, 76.6, 30.0, 76.5, 29.1, 76.5);
((GeneralPath)shape).curveTo(28.2, 76.5, 27.4, 76.7, 26.9, 77.1);
((GeneralPath)shape).curveTo(26.6, 77.299995, 26.4, 77.7, 26.4, 78.1);
((GeneralPath)shape).curveTo(26.4, 78.5, 26.6, 78.799995, 26.9, 79.1);
((GeneralPath)shape).curveTo(27.3, 79.4, 28.3, 79.799995, 29.9, 80.2);
((GeneralPath)shape).curveTo(31.5, 80.6, 32.6, 80.899994, 33.4, 81.299995);
((GeneralPath)shape).curveTo(34.100002, 81.7, 34.7, 82.2, 35.2, 82.899994);
((GeneralPath)shape).curveTo(35.600002, 83.59999, 35.8, 84.399994, 35.8, 85.399994);
((GeneralPath)shape).curveTo(35.8, 86.299995, 35.5, 87.09999, 35.0, 87.899994);
((GeneralPath)shape).curveTo(34.5, 88.7, 33.8, 89.299995, 32.9, 89.7);
((GeneralPath)shape).curveTo(32.0, 90.1, 30.800001, 90.299995, 29.400002, 90.299995);
((GeneralPath)shape).curveTo(27.400002, 90.299995, 25.800001, 89.799995, 24.800001, 88.899994);
((GeneralPath)shape).curveTo(23.6, 87.8, 23.0, 86.5, 22.8, 84.7);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(76, 108, 123, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(38.4, 89.8);
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(41.6, 76.7);
((GeneralPath)shape).lineTo(41.6, 81.2);
((GeneralPath)shape).lineTo(43.399998, 81.2);
((GeneralPath)shape).curveTo(44.699997, 81.2, 45.499996, 81.1, 45.899998, 81.0);
((GeneralPath)shape).curveTo(46.3, 80.9, 46.699997, 80.6, 46.899998, 80.2);
((GeneralPath)shape).curveTo(47.1, 79.799995, 47.3, 79.399994, 47.3, 79.0);
((GeneralPath)shape).curveTo(47.3, 78.4, 47.1, 78.0, 46.8, 77.6);
((GeneralPath)shape).curveTo(46.5, 77.2, 46.0, 77.0, 45.5, 76.9);
((GeneralPath)shape).curveTo(45.1, 76.8, 44.3, 76.8, 43.2, 76.8);
((GeneralPath)shape).lineTo(41.6, 76.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_aspx of(int width, int height) {
       ext_aspx result = new ext_aspx();
       result.width = width;

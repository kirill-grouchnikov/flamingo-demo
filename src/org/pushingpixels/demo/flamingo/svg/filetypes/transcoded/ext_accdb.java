 ...
 */
public class ext_accdb implements
...
((GeneralPath)shape).curveTo(24.599997, 80.2, 23.999996, 80.0, 23.299997, 80.0);
((GeneralPath)shape).curveTo(22.299997, 80.0, 21.499998, 80.3, 20.899998, 81.0);
((GeneralPath)shape).curveTo(20.299997, 81.7, 19.999998, 82.8, 19.999998, 84.3);
((GeneralPath)shape).curveTo(19.999998, 85.9, 20.299997, 87.100006, 20.899998, 87.8);
((GeneralPath)shape).curveTo(21.499998, 88.5, 22.299997, 88.8, 23.199997, 88.8);
((GeneralPath)shape).curveTo(23.899998, 88.8, 24.499996, 88.600006, 24.999996, 88.100006);
((GeneralPath)shape).curveTo(25.7, 88.0, 26.0, 87.3, 26.3, 86.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).curveTo(38.9, 88.0, 39.3, 87.3, 39.5, 86.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(44.3, 78.2);
((GeneralPath)shape).lineTo(49.1, 78.2);
((GeneralPath)shape).curveTo(50.199997, 78.2, 51.0, 78.299995, 51.6, 78.399994);
((GeneralPath)shape).curveTo(52.399998, 78.59999, 53.0, 78.99999, 53.6, 79.59999);
((GeneralPath)shape).curveTo(54.1, 80.19999, 54.6, 80.899994, 54.899998, 81.69999);
((GeneralPath)shape).curveTo(55.199997, 82.49999, 55.3, 83.49999, 55.3, 84.69999);
((GeneralPath)shape).curveTo(55.3, 85.79999, 55.2, 86.69999, 54.899998, 87.39999);
((GeneralPath)shape).curveTo(54.6, 88.29999, 54.1, 89.09998, 53.499996, 89.69999);
((GeneralPath)shape).curveTo(52.999996, 90.09999, 52.399998, 90.49999, 51.599995, 90.69999);
((GeneralPath)shape).curveTo(50.999996, 90.89999, 50.199993, 90.99999, 49.299995, 90.99999);
((GeneralPath)shape).lineTo(44.299995, 90.99999);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(57.5, 78.2);
((GeneralPath)shape).lineTo(62.7, 78.2);
((GeneralPath)shape).curveTo(63.7, 78.2, 64.5, 78.2, 65.0, 78.299995);
((GeneralPath)shape).curveTo(65.5, 78.399994, 66.0, 78.6, 66.4, 78.799995);
((GeneralPath)shape).curveTo(66.8, 78.99999, 67.1, 79.399994, 67.4, 79.899994);
((GeneralPath)shape).curveTo(67.700005, 80.299995, 67.8, 80.899994, 67.8, 81.399994);
((GeneralPath)shape).curveTo(67.8, 81.99999, 67.600006, 82.59999, 67.3, 83.09999);
((GeneralPath)shape).curveTo(67.0, 83.59999, 66.5, 83.99999, 66.0, 84.19999);
((GeneralPath)shape).curveTo(66.8, 84.39999, 67.4, 84.79999, 67.8, 85.39999);
((GeneralPath)shape).curveTo(68.200005, 85.999985, 68.4, 86.59998, 68.4, 87.29999);
((GeneralPath)shape).curveTo(68.4, 87.89999, 68.3, 88.499985, 68.0, 88.999985);
((GeneralPath)shape).curveTo(67.7, 89.59998, 67.3, 89.999985, 66.9, 90.29999);
((GeneralPath)shape).curveTo(66.4, 90.59999, 65.8, 90.79999, 65.1, 90.89999);
((GeneralPath)shape).curveTo(64.7, 90.89999, 63.6, 90.999985, 61.899998, 90.999985);
((GeneralPath)shape).lineTo(57.399998, 90.999985);
((GeneralPath)shape).lineTo(57.399998, 78.2);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(60.2, 80.3);
((GeneralPath)shape).lineTo(60.2, 83.3);
((GeneralPath)shape).lineTo(61.9, 83.3);
((GeneralPath)shape).curveTo(62.9, 83.3, 63.600002, 83.3, 63.800003, 83.3);
((GeneralPath)shape).curveTo(64.3, 83.200005, 64.600006, 83.100006, 64.9, 82.8);
...
((GeneralPath)shape).curveTo(63.7, 80.3, 63.0, 80.3, 61.7, 80.3);
...
((GeneralPath)shape).lineTo(60.2, 85.40001);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_accdb of(int width, int height) {
       ext_accdb result = new ext_accdb();
       result.width = width;

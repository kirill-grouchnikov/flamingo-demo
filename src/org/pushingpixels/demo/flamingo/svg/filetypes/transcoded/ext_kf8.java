 ...
 */
public class ext_kf8 implements
...
((GeneralPath)shape).lineTo(20.2, 76.0);
((GeneralPath)shape).lineTo(20.2, 82.9);
((GeneralPath)shape).lineTo(26.6, 76.0);
((GeneralPath)shape).lineTo(31.0, 76.0);
((GeneralPath)shape).lineTo(25.0, 82.1);
((GeneralPath)shape).lineTo(31.3, 91.6);
((GeneralPath)shape).lineTo(27.199999, 91.6);
((GeneralPath)shape).lineTo(22.899998, 84.299995);
((GeneralPath)shape).lineTo(20.299997, 86.899994);
((GeneralPath)shape).lineTo(20.299997, 91.59999);
((GeneralPath)shape).lineTo(17.0, 91.59999);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(254, 254, 254, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(33.0, 91.6);
((GeneralPath)shape).lineTo(33.0, 76.0);
((GeneralPath)shape).lineTo(43.8, 76.0);
((GeneralPath)shape).lineTo(43.8, 78.6);
((GeneralPath)shape).lineTo(36.2, 78.6);
((GeneralPath)shape).lineTo(36.2, 82.299995);
((GeneralPath)shape).lineTo(42.8, 82.299995);
((GeneralPath)shape).lineTo(42.8, 85.0);
((GeneralPath)shape).lineTo(36.2, 85.0);
((GeneralPath)shape).lineTo(36.2, 91.6);
((GeneralPath)shape).lineTo(33.0, 91.6);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(254, 254, 254, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(48.3, 83.2);
((GeneralPath)shape).curveTo(47.5, 82.899994, 46.899998, 82.399994, 46.6, 81.899994);
((GeneralPath)shape).curveTo(46.199997, 81.299995, 46.1, 80.7, 46.1, 79.99999);
((GeneralPath)shape).curveTo(46.1, 78.799995, 46.5, 77.899994, 47.3, 77.09999);
((GeneralPath)shape).curveTo(48.1, 76.29999, 49.3, 75.99999, 50.8, 75.99999);
((GeneralPath)shape).curveTo(52.3, 75.99999, 53.5, 76.399994, 54.3, 77.09999);
((GeneralPath)shape).curveTo(55.1, 77.899994, 55.5, 78.79999, 55.5, 79.99999);
((GeneralPath)shape).curveTo(55.5, 80.69999, 55.3, 81.399994, 54.9, 81.899994);
((GeneralPath)shape).curveTo(54.500004, 82.399994, 54.0, 82.899994, 53.300003, 83.2);
((GeneralPath)shape).curveTo(54.200005, 83.5, 54.800003, 84.1, 55.300003, 84.7);
((GeneralPath)shape).curveTo(55.800003, 85.299995, 56.000004, 86.1, 56.000004, 87.0);
((GeneralPath)shape).curveTo(56.000004, 88.4, 55.500004, 89.6, 54.600002, 90.5);
((GeneralPath)shape).curveTo(53.7, 91.4, 52.4, 91.8, 50.9, 91.8);
((GeneralPath)shape).curveTo(49.5, 91.8, 48.300003, 91.4, 47.300003, 90.700005);
((GeneralPath)shape).curveTo(46.200005, 89.8, 45.600002, 88.600006, 45.600002, 87.100006);
((GeneralPath)shape).curveTo(45.600002, 86.3, 45.800003, 85.50001, 46.2, 84.8);
((GeneralPath)shape).curveTo(46.8, 84.1, 47.4, 83.6, 48.3, 83.2);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(48.7, 86.8);
((GeneralPath)shape).curveTo(48.7, 87.600006, 48.9, 88.3, 49.3, 88.700005);
((GeneralPath)shape).curveTo(49.7, 89.200005, 50.3, 89.4, 50.899998, 89.4);
((GeneralPath)shape).curveTo(51.499996, 89.4, 51.999996, 89.200005, 52.499996, 88.700005);
((GeneralPath)shape).curveTo(52.899998, 88.3, 53.099995, 87.600006, 53.099995, 86.8);
((GeneralPath)shape).curveTo(53.099995, 86.100006, 52.899994, 85.5, 52.499996, 85.0);
((GeneralPath)shape).curveTo(52.099995, 84.6, 51.599995, 84.3, 50.899998, 84.3);
((GeneralPath)shape).curveTo(50.199997, 84.3, 49.6, 84.600006, 49.199997, 85.100006);
((GeneralPath)shape).curveTo(48.9, 85.7, 48.7, 86.2, 48.7, 86.8);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(49.0, 80.2);
((GeneralPath)shape).curveTo(49.0, 80.799995, 49.2, 81.299995, 49.5, 81.6);
((GeneralPath)shape).curveTo(49.8, 81.9, 50.3, 82.1, 50.9, 82.1);
((GeneralPath)shape).curveTo(51.5, 82.1, 51.9, 81.9, 52.300003, 81.6);
((GeneralPath)shape).curveTo(52.600002, 81.299995, 52.800003, 80.799995, 52.800003, 80.2);
((GeneralPath)shape).curveTo(52.800003, 79.6, 52.600002, 79.2, 52.300003, 78.899994);
((GeneralPath)shape).curveTo(52.000004, 78.59999, 51.500004, 78.399994, 50.9, 78.399994);
((GeneralPath)shape).curveTo(50.300003, 78.399994, 49.9, 78.59999, 49.5, 78.899994);
((GeneralPath)shape).curveTo(49.1, 79.2, 49.0, 79.6, 49.0, 80.2);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_kf8 of(int width, int height) {
       ext_kf8 result = new ext_kf8();
       result.width = width;

 ...
 */
public class ext_vmdk implements
...
paint = new Color(160, 120, 2, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(37.9, 74.3);
((GeneralPath)shape).lineTo(43.800003, 74.3);
((GeneralPath)shape).curveTo(45.100002, 74.3, 46.100002, 74.4, 46.800003, 74.600006);
((GeneralPath)shape).curveTo(47.700005, 74.90001, 48.500004, 75.40001, 49.200005, 76.100006);
((GeneralPath)shape).curveTo(49.900005, 76.8, 50.400005, 77.600006, 50.700005, 78.700005);
((GeneralPath)shape).curveTo(51.000004, 79.700005, 51.200005, 80.9, 51.200005, 82.4);
((GeneralPath)shape).curveTo(51.200005, 83.700005, 51.000004, 84.8, 50.700005, 85.8);
((GeneralPath)shape).curveTo(50.300003, 86.9, 49.700005, 87.9, 49.000004, 88.600006);
((GeneralPath)shape).curveTo(48.400005, 89.100006, 47.700005, 89.600006, 46.700005, 89.90001);
((GeneralPath)shape).curveTo(46.000004, 90.100006, 45.000004, 90.20001, 43.900005, 90.20001);
((GeneralPath)shape).lineTo(37.900005, 90.20001);
((GeneralPath)shape).lineTo(37.900005, 74.3);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(41.1, 77.0);
((GeneralPath)shape).lineTo(41.1, 87.4);
((GeneralPath)shape).lineTo(43.5, 87.4);
((GeneralPath)shape).curveTo(44.4, 87.4, 45.0, 87.4, 45.4, 87.200005);
((GeneralPath)shape).curveTo(45.9, 87.100006, 46.4, 86.9, 46.7, 86.50001);
((GeneralPath)shape).curveTo(47.0, 86.10001, 47.3, 85.700005, 47.5, 85.00001);
((GeneralPath)shape).curveTo(47.7, 84.30001, 47.8, 83.30001, 47.8, 82.100006);
((GeneralPath)shape).curveTo(47.8, 80.9, 47.7, 79.90001, 47.5, 79.3);
((GeneralPath)shape).curveTo(47.3, 78.600006, 47.0, 78.100006, 46.6, 77.8);
((GeneralPath)shape).curveTo(46.199997, 77.5, 45.699997, 77.200005, 45.1, 77.100006);
((GeneralPath)shape).curveTo(44.7, 77.0, 43.8, 77.0, 42.5, 77.0);
((GeneralPath)shape).lineTo(41.1, 77.0);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_vmdk of(int width, int height) {
       ext_vmdk result = new ext_vmdk();
       result.width = width;

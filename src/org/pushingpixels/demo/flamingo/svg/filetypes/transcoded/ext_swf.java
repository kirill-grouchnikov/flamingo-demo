 ...
 */
public class ext_swf implements
...
((GeneralPath)shape).curveTo(7.2, 88.5, 6.3, 86.8, 6.1, 84.6);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(45.499996, 91.0);
((GeneralPath)shape).lineTo(41.199997, 91.0);
((GeneralPath)shape).lineTo(37.199997, 76.2);
((GeneralPath)shape).lineTo(33.199997, 91.0);
((GeneralPath)shape).lineTo(28.8, 91.0);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_swf of(int width, int height) {
       ext_swf result = new ext_swf();
       result.width = width;

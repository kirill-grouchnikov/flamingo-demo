 ...
 */
public class ext_mdf implements
...
paint = new Color(76, 108, 123, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(31.9, 69.8);
...
((GeneralPath)shape).lineTo(32.000004, 89.700005);
((GeneralPath)shape).lineTo(32.000004, 69.8);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(36.0, 73.2);
((GeneralPath)shape).lineTo(36.0, 86.5);
((GeneralPath)shape).lineTo(39.0, 86.5);
((GeneralPath)shape).curveTo(40.1, 86.5, 41.0, 86.4, 41.5, 86.3);
((GeneralPath)shape).curveTo(42.2, 86.100006, 42.7, 85.9, 43.2, 85.5);
((GeneralPath)shape).curveTo(43.7, 85.1, 44.0, 84.5, 44.3, 83.6);
((GeneralPath)shape).curveTo(44.6, 82.7, 44.7, 81.5, 44.7, 79.9);
((GeneralPath)shape).curveTo(44.7, 78.3, 44.600002, 77.200005, 44.3, 76.3);
((GeneralPath)shape).curveTo(43.999996, 75.4, 43.6, 74.8, 43.1, 74.4);
((GeneralPath)shape).curveTo(42.6, 73.9, 42.0, 73.6, 41.199997, 73.5);
((GeneralPath)shape).curveTo(40.6, 73.4, 39.499996, 73.3, 37.799995, 73.3);
((GeneralPath)shape).lineTo(36.0, 73.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_mdf of(int width, int height) {
       ext_mdf result = new ext_mdf();
       result.width = width;

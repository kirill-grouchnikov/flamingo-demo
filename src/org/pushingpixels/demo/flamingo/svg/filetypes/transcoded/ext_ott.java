 ...
 */
public class ext_ott implements
...
((GeneralPath)shape).curveTo(9.7, 86.9, 8.8, 84.4, 8.8, 81.3);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(13.0, 81.1);
((GeneralPath)shape).curveTo(13.0, 83.299995, 13.5, 85.1, 14.6, 86.2);
((GeneralPath)shape).curveTo(15.6, 87.399994, 17.0, 87.899994, 18.6, 87.899994);
((GeneralPath)shape).curveTo(20.2, 87.899994, 21.5, 87.299995, 22.6, 86.2);
((GeneralPath)shape).curveTo(23.6, 85.0, 24.2, 83.299995, 24.2, 81.0);
((GeneralPath)shape).curveTo(24.2, 78.7, 23.7, 77.0, 22.7, 75.9);
((GeneralPath)shape).curveTo(21.7, 74.8, 20.400002, 74.200005, 18.7, 74.200005);
((GeneralPath)shape).curveTo(17.0, 74.200005, 15.700001, 74.8, 14.700001, 75.9);
((GeneralPath)shape).curveTo(13.5, 77.1, 13.0, 78.8, 13.0, 81.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(35.9, 91.1);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(53.0, 91.1);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_ott of(int width, int height) {
       ext_ott result = new ext_ott();
       result.width = width;

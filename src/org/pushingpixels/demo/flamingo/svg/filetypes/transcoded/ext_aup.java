 ...
 */
public class ext_aup implements
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(19.6, 83.3);
((GeneralPath)shape).lineTo(16.800001, 75.9);
((GeneralPath)shape).lineTo(14.100001, 83.3);
((GeneralPath)shape).lineTo(19.6, 83.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(29.2, 71.3);
((GeneralPath)shape).lineTo(33.3, 71.3);
...
((GeneralPath)shape).lineTo(49.5, 91.20001);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(53.6, 74.59999);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_aup of(int width, int height) {
       ext_aup result = new ext_aup();
       result.width = width;

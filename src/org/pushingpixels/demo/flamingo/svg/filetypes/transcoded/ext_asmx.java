 ...
 */
public class ext_asmx implements
...
((GeneralPath)shape).lineTo(19.9, 89.8);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(30.0, 84.0, 29.6, 83.8, 29.0, 83.6);
((GeneralPath)shape).curveTo(28.6, 83.5, 27.8, 83.2, 26.4, 82.9);
((GeneralPath)shape).curveTo(24.699999, 82.5, 23.5, 82.0, 22.8, 81.3);
((GeneralPath)shape).curveTo(21.8, 80.4, 21.3, 79.4, 21.3, 78.100006);
((GeneralPath)shape).curveTo(21.3, 77.3, 21.5, 76.50001, 22.0, 75.90001);
((GeneralPath)shape).curveTo(22.5, 75.20001, 23.1, 74.70001, 24.0, 74.30001);
((GeneralPath)shape).curveTo(24.9, 73.90001, 25.9, 73.80001, 27.1, 73.80001);
((GeneralPath)shape).curveTo(29.1, 73.80001, 30.6, 74.20001, 31.6, 75.10001);
((GeneralPath)shape).curveTo(32.6, 76.000015, 33.1, 77.10001, 33.2, 78.60001);
((GeneralPath)shape).lineTo(30.0, 78.7);
((GeneralPath)shape).curveTo(29.9, 77.899994, 29.6, 77.299995, 29.1, 77.0);
((GeneralPath)shape).curveTo(28.6, 76.6, 28.0, 76.5, 27.1, 76.5);
((GeneralPath)shape).curveTo(26.2, 76.5, 25.4, 76.7, 24.9, 77.1);
((GeneralPath)shape).curveTo(24.6, 77.299995, 24.4, 77.7, 24.4, 78.1);
((GeneralPath)shape).curveTo(24.4, 78.5, 24.6, 78.799995, 24.9, 79.1);
((GeneralPath)shape).curveTo(25.3, 79.4, 26.3, 79.799995, 27.9, 80.2);
((GeneralPath)shape).curveTo(29.5, 80.6, 30.6, 80.899994, 31.4, 81.299995);
((GeneralPath)shape).curveTo(32.1, 81.7, 32.7, 82.2, 33.2, 82.899994);
((GeneralPath)shape).curveTo(33.600002, 83.59999, 33.8, 84.399994, 33.8, 85.399994);
((GeneralPath)shape).curveTo(33.8, 86.299995, 33.5, 87.09999, 33.0, 87.899994);
((GeneralPath)shape).curveTo(32.5, 88.7, 31.8, 89.299995, 30.9, 89.7);
((GeneralPath)shape).curveTo(30.0, 90.1, 28.8, 90.299995, 27.4, 90.299995);
((GeneralPath)shape).curveTo(25.4, 90.299995, 23.8, 89.799995, 22.8, 88.899994);
((GeneralPath)shape).curveTo(21.6, 87.8, 21.0, 86.5, 20.8, 84.7);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(47.000004, 74.1);
((GeneralPath)shape).lineTo(51.800003, 74.1);
((GeneralPath)shape).lineTo(51.800003, 89.799995);
((GeneralPath)shape).lineTo(48.800003, 89.799995);
((GeneralPath)shape).lineTo(48.800003, 77.4);
((GeneralPath)shape).lineTo(45.600002, 89.8);
((GeneralPath)shape).lineTo(42.500004, 89.8);
((GeneralPath)shape).lineTo(39.400005, 77.4);
((GeneralPath)shape).lineTo(39.400005, 89.8);
...
paint = new Color(76, 108, 123, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(53.3, 89.8);
((GeneralPath)shape).lineTo(58.7, 81.600006);
((GeneralPath)shape).lineTo(53.8, 74.100006);
((GeneralPath)shape).lineTo(57.6, 74.100006);
((GeneralPath)shape).lineTo(60.8, 79.200005);
((GeneralPath)shape).lineTo(63.899998, 74.100006);
((GeneralPath)shape).lineTo(67.6, 74.100006);
((GeneralPath)shape).lineTo(62.699997, 81.700005);
((GeneralPath)shape).lineTo(68.1, 89.8);
((GeneralPath)shape).lineTo(64.2, 89.8);
((GeneralPath)shape).lineTo(60.699997, 84.4);
((GeneralPath)shape).lineTo(57.199997, 89.8);
((GeneralPath)shape).lineTo(53.3, 89.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_asmx of(int width, int height) {
       ext_asmx result = new ext_asmx();
       result.width = width;

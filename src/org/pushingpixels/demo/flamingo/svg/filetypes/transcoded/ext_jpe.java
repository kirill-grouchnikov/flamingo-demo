 ...
 */
public class ext_jpe implements
...
((GeneralPath)shape).lineTo(27.4, 91.100006);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(31.4, 74.6);
((GeneralPath)shape).lineTo(31.4, 80.2);
((GeneralPath)shape).lineTo(33.6, 80.2);
((GeneralPath)shape).curveTo(35.199997, 80.2, 36.3, 80.1, 36.8, 79.899994);
((GeneralPath)shape).curveTo(37.3, 79.7, 37.8, 79.399994, 38.1, 78.899994);
((GeneralPath)shape).curveTo(38.399998, 78.49999, 38.6, 77.899994, 38.6, 77.399994);
((GeneralPath)shape).curveTo(38.6, 76.7, 38.399998, 76.09999, 38.0, 75.59999);
((GeneralPath)shape).curveTo(37.6, 75.09999, 37.0, 74.79999, 36.4, 74.69999);
((GeneralPath)shape).curveTo(35.9, 74.59999, 35.0, 74.59999, 33.5, 74.59999);
((GeneralPath)shape).lineTo(31.4, 74.59999);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(61.2, 91.00001);
((GeneralPath)shape).lineTo(46.0, 91.00001);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_jpe of(int width, int height) {
       ext_jpe result = new ext_jpe();
       result.width = width;

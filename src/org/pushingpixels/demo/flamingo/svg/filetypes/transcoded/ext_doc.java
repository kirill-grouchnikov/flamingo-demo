 ...
 */
public class ext_doc implements
...
((GeneralPath)shape).curveTo(26.9, 86.9, 26.0, 84.4, 26.0, 81.3);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(30.2, 81.1);
((GeneralPath)shape).curveTo(30.2, 83.299995, 30.7, 85.1, 31.800001, 86.2);
((GeneralPath)shape).curveTo(32.800003, 87.399994, 34.2, 87.899994, 35.800003, 87.899994);
((GeneralPath)shape).curveTo(37.400005, 87.899994, 38.700005, 87.299995, 39.800003, 86.2);
((GeneralPath)shape).curveTo(40.800003, 85.0, 41.4, 83.299995, 41.4, 81.0);
((GeneralPath)shape).curveTo(41.4, 78.7, 40.9, 77.0, 39.9, 75.9);
((GeneralPath)shape).curveTo(38.9, 74.8, 37.600002, 74.200005, 35.9, 74.200005);
((GeneralPath)shape).curveTo(34.2, 74.200005, 32.9, 74.8, 31.900002, 75.9);
((GeneralPath)shape).curveTo(30.7, 77.1, 30.2, 78.8, 30.2, 81.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).curveTo(54.400005, 87.6, 55.5, 88.0, 57.0, 88.0);
((GeneralPath)shape).curveTo(58.1, 88.0, 59.0, 87.7, 59.8, 87.0);
((GeneralPath)shape).curveTo(60.6, 86.3, 61.1, 85.2, 61.4, 83.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_doc of(int width, int height) {
       ext_doc result = new ext_doc();
       result.width = width;

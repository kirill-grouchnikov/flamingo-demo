 ...
 */
public class ext_pot implements
...
((GeneralPath)shape).lineTo(15.2, 91.399994);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(18.3, 78.600006);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(254, 254, 254, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(29.2, 83.9);
((GeneralPath)shape).curveTo(29.2, 82.3, 29.400002, 81.0, 29.900002, 79.9);
((GeneralPath)shape).curveTo(30.300001, 79.1, 30.7, 78.4, 31.400002, 77.8);
((GeneralPath)shape).curveTo(32.100002, 77.200005, 32.7, 76.700005, 33.4, 76.4);
...
((GeneralPath)shape).curveTo(29.9, 88.3, 29.2, 86.4, 29.2, 83.9);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(32.9, 80.6, 32.5, 82.0, 32.5, 83.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(254, 254, 254, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(50.6, 91.6);
((GeneralPath)shape).lineTo(50.6, 78.6);
((GeneralPath)shape).lineTo(45.899998, 78.6);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_pot of(int width, int height) {
       ext_pot result = new ext_pot();
       result.width = width;

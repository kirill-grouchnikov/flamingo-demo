 ...
 */
public class ext_jpeg implements
...
((GeneralPath)shape).curveTo(7.5, 89.2, 7.0, 87.9, 7.0, 86.2);
((GeneralPath)shape).lineTo(10.0, 85.899994);
((GeneralPath)shape).curveTo(10.0, 86.799995, 10.2, 87.399994, 10.4, 87.799995);
((GeneralPath)shape).curveTo(10.7, 88.399994, 11.299999, 88.6, 12.0, 88.6);
((GeneralPath)shape).curveTo(12.7, 88.6, 13.2, 88.4, 13.5, 88.0);
((GeneralPath)shape).curveTo(13.8, 87.6, 13.9, 86.8, 13.9, 85.5);
((GeneralPath)shape).lineTo(13.9, 75.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(20.6, 91.1);
...
((GeneralPath)shape).curveTo(27.3, 78.0, 26.5, 78.0, 25.3, 78.0);
((GeneralPath)shape).lineTo(23.8, 78.0);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(57.5, 85.3);
((GeneralPath)shape).lineTo(57.5, 82.600006);
((GeneralPath)shape).lineTo(64.4, 82.600006);
((GeneralPath)shape).lineTo(64.4, 88.90001);
((GeneralPath)shape).curveTo(63.7, 89.50001, 62.800003, 90.100006, 61.5, 90.600006);
((GeneralPath)shape).curveTo(60.2, 91.100006, 58.9, 91.3, 57.6, 91.3);
((GeneralPath)shape).curveTo(55.899998, 91.3, 54.5, 91.0, 53.3, 90.3);
((GeneralPath)shape).curveTo(52.1, 89.600006, 51.1, 88.600006, 50.5, 87.3);
((GeneralPath)shape).curveTo(49.9, 86.0, 49.6, 84.600006, 49.6, 83.100006);
((GeneralPath)shape).curveTo(49.6, 81.50001, 49.899998, 80.00001, 50.6, 78.700005);
((GeneralPath)shape).curveTo(51.3, 77.4, 52.3, 76.4, 53.6, 75.8);
((GeneralPath)shape).curveTo(54.6, 75.3, 55.899998, 75.0, 57.399998, 75.0);
((GeneralPath)shape).curveTo(59.399998, 75.0, 60.899998, 75.4, 61.999996, 76.2);
((GeneralPath)shape).curveTo(63.099995, 77.0, 63.799995, 78.2, 64.1, 79.6);
((GeneralPath)shape).lineTo(61.0, 80.3);
((GeneralPath)shape).curveTo(60.8, 79.5, 60.4, 78.9, 59.7, 78.5);
((GeneralPath)shape).curveTo(59.100002, 78.1, 58.3, 77.8, 57.4, 77.8);
((GeneralPath)shape).curveTo(56.0, 77.8, 54.9, 78.200005, 54.100002, 79.100006);
((GeneralPath)shape).curveTo(53.300003, 80.00001, 52.9, 81.3, 52.9, 83.00001);
((GeneralPath)shape).curveTo(52.9, 84.90001, 53.300003, 86.30001, 54.2, 87.200005);
((GeneralPath)shape).curveTo(55.0, 88.100006, 56.100002, 88.600006, 57.5, 88.600006);
((GeneralPath)shape).curveTo(58.2, 88.600006, 58.8, 88.50001, 59.5, 88.200005);
((GeneralPath)shape).curveTo(60.2, 87.9, 60.8, 87.600006, 61.2, 87.200005);
((GeneralPath)shape).lineTo(61.2, 85.200005);
((GeneralPath)shape).lineTo(57.5, 85.200005);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_jpeg of(int width, int height) {
       ext_jpeg result = new ext_jpeg();
       result.width = width;

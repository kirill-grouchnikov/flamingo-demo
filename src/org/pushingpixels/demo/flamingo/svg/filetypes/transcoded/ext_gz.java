 ...
 */
public class ext_gz implements
...
((GeneralPath)shape).lineTo(27.1, 85.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(160, 120, 2, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(37.7, 92.2);
((GeneralPath)shape).lineTo(37.7, 88.6);
((GeneralPath)shape).lineTo(48.2, 75.7);
((GeneralPath)shape).lineTo(38.9, 75.7);
((GeneralPath)shape).lineTo(38.9, 72.299995);
((GeneralPath)shape).lineTo(53.5, 72.299995);
((GeneralPath)shape).lineTo(53.5, 75.399994);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_gz of(int width, int height) {
       ext_gz result = new ext_gz();
       result.width = width;

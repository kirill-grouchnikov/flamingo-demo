 ...
 */
public class ext_app implements
...
((GeneralPath)shape).lineTo(52.8, 74.59999);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_app of(int width, int height) {
       ext_app result = new ext_app();
       result.width = width;

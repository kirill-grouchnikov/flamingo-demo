...
((GeneralPath)shape).lineTo(28.9, 70.0);
((GeneralPath)shape).lineTo(32.9, 70.0);
((GeneralPath)shape).lineTo(32.9, 77.8);
((GeneralPath)shape).lineTo(40.800003, 77.8);
((GeneralPath)shape).lineTo(40.800003, 70.0);
((GeneralPath)shape).lineTo(44.800003, 70.0);
((GeneralPath)shape).lineTo(44.800003, 89.8);
((GeneralPath)shape).lineTo(40.800003, 89.8);
((GeneralPath)shape).lineTo(40.800003, 81.100006);
((GeneralPath)shape).lineTo(32.9, 81.100006);
((GeneralPath)shape).lineTo(32.9, 89.8);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_h of(int width, int height) {
       ext_h result = new ext_h();
       result.width = width;

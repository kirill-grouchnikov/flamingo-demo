 ...
 */
public class ext_otf implements
...
((GeneralPath)shape).curveTo(10.6, 87.9, 9.7, 85.4, 9.7, 82.3);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(13.8, 82.1);
((GeneralPath)shape).curveTo(13.8, 84.299995, 14.3, 86.1, 15.400001, 87.2);
((GeneralPath)shape).curveTo(16.400002, 88.399994, 17.800001, 88.899994, 19.400002, 88.899994);
((GeneralPath)shape).curveTo(21.000002, 88.899994, 22.300001, 88.299995, 23.400002, 87.2);
((GeneralPath)shape).curveTo(24.500002, 86.1, 24.900002, 84.299995, 24.900002, 82.0);
((GeneralPath)shape).curveTo(24.900002, 79.7, 24.400002, 78.0, 23.400002, 76.9);
((GeneralPath)shape).curveTo(22.400002, 75.8, 21.100002, 75.200005, 19.400002, 75.200005);
((GeneralPath)shape).curveTo(17.7, 75.200005, 16.400002, 75.8, 15.400002, 76.9);
((GeneralPath)shape).curveTo(14.3, 78.1, 13.8, 79.8, 13.8, 82.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(76, 98, 123, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(36.7, 92.1);
((GeneralPath)shape).lineTo(36.7, 75.6);
((GeneralPath)shape).lineTo(30.800001, 75.6);
((GeneralPath)shape).lineTo(30.800001, 72.2);
((GeneralPath)shape).lineTo(46.7, 72.2);
((GeneralPath)shape).lineTo(46.7, 75.6);
((GeneralPath)shape).lineTo(40.8, 75.6);
((GeneralPath)shape).lineTo(40.8, 92.1);
((GeneralPath)shape).lineTo(36.7, 92.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(76, 98, 123, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(49.2, 92.1);
((GeneralPath)shape).lineTo(49.2, 72.2);
((GeneralPath)shape).lineTo(62.9, 72.2);
((GeneralPath)shape).lineTo(62.9, 75.6);
((GeneralPath)shape).lineTo(53.2, 75.6);
((GeneralPath)shape).lineTo(53.2, 80.299995);
((GeneralPath)shape).lineTo(61.5, 80.299995);
((GeneralPath)shape).lineTo(61.5, 83.7);
((GeneralPath)shape).lineTo(53.2, 83.7);
((GeneralPath)shape).lineTo(53.2, 92.1);
((GeneralPath)shape).lineTo(49.2, 92.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_otf of(int width, int height) {
       ext_otf result = new ext_otf();
       result.width = width;

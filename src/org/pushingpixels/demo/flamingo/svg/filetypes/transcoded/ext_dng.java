 ...
 */
public class ext_dng implements
...
((GeneralPath)shape).lineTo(11.2, 74.7);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(27.4, 91.1);
((GeneralPath)shape).lineTo(27.4, 71.2);
((GeneralPath)shape).lineTo(31.3, 71.2);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(56.8, 83.8);
((GeneralPath)shape).lineTo(56.8, 80.5);
((GeneralPath)shape).lineTo(65.5, 80.5);
((GeneralPath)shape).lineTo(65.5, 88.4);
((GeneralPath)shape).curveTo(64.7, 89.200005, 63.4, 89.9, 61.8, 90.5);
((GeneralPath)shape).curveTo(60.2, 91.1, 58.6, 91.4, 56.899998, 91.4);
((GeneralPath)shape).curveTo(54.8, 91.4, 52.999996, 91.0, 51.399998, 90.1);
((GeneralPath)shape).curveTo(50.0, 89.2, 48.8, 88.0, 48.0, 86.4);
((GeneralPath)shape).curveTo(47.2, 84.8, 46.8, 83.0, 46.8, 81.1);
((GeneralPath)shape).curveTo(46.8, 79.0, 47.2, 77.2, 48.1, 75.6);
((GeneralPath)shape).curveTo(49.0, 74.0, 50.199997, 72.799995, 51.899998, 71.9);
((GeneralPath)shape).curveTo(53.199997, 71.200005, 54.8, 70.9, 56.699997, 70.9);
((GeneralPath)shape).curveTo(59.199997, 70.9, 61.1, 71.4, 62.499996, 72.4);
((GeneralPath)shape).curveTo(63.899994, 73.4, 64.799995, 74.9, 65.2, 76.700005);
((GeneralPath)shape).lineTo(61.199997, 77.4);
((GeneralPath)shape).curveTo(60.899998, 76.4, 60.399998, 75.700005, 59.6, 75.1);
((GeneralPath)shape).curveTo(58.8, 74.5, 57.899998, 74.299995, 56.699997, 74.299995);
((GeneralPath)shape).curveTo(54.899998, 74.299995, 53.499996, 74.899994, 52.499996, 75.99999);
((GeneralPath)shape).curveTo(51.499996, 77.09999, 50.899998, 78.799995, 50.899998, 80.899994);
((GeneralPath)shape).curveTo(50.899998, 83.299995, 51.399998, 84.99999, 52.499996, 86.2);
((GeneralPath)shape).curveTo(53.599995, 87.4, 55.0, 88.0, 56.7, 88.0);
...
((GeneralPath)shape).lineTo(56.8, 83.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_dng of(int width, int height) {
       ext_dng result = new ext_dng();
       result.width = width;

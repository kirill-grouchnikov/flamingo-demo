 ...
 */
public class ext_potx implements
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(10.2, 78.2);
((GeneralPath)shape).lineTo(10.2, 82.7);
((GeneralPath)shape).lineTo(12.0, 82.7);
((GeneralPath)shape).curveTo(13.3, 82.7, 14.1, 82.6, 14.5, 82.5);
((GeneralPath)shape).curveTo(14.9, 82.3, 15.3, 82.1, 15.5, 81.7);
((GeneralPath)shape).curveTo(15.7, 81.299995, 15.9, 80.899994, 15.9, 80.5);
((GeneralPath)shape).curveTo(15.9, 79.9, 15.7, 79.5, 15.4, 79.1);
((GeneralPath)shape).curveTo(15.099999, 78.7, 14.599999, 78.5, 14.099999, 78.4);
((GeneralPath)shape).curveTo(13.7, 78.3, 12.999999, 78.3, 11.799999, 78.3);
((GeneralPath)shape).lineTo(10.2, 78.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(21.2, 83.5);
((GeneralPath)shape).curveTo(21.2, 81.9, 21.400002, 80.5, 21.900002, 79.5);
((GeneralPath)shape).curveTo(22.300001, 78.7, 22.800001, 78.0, 23.400002, 77.3);
((GeneralPath)shape).curveTo(24.000002, 76.600006, 24.7, 76.200005, 25.400002, 75.9);
((GeneralPath)shape).curveTo(26.400002, 75.5, 27.500002, 75.3, 28.800001, 75.3);
((GeneralPath)shape).curveTo(31.1, 75.3, 33.0, 76.0, 34.4, 77.5);
((GeneralPath)shape).curveTo(35.800003, 79.0, 36.5, 80.9, 36.5, 83.5);
((GeneralPath)shape).curveTo(36.5, 86.0, 35.8, 88.0, 34.4, 89.5);
((GeneralPath)shape).curveTo(33.0, 90.9, 31.100002, 91.7, 28.800001, 91.7);
((GeneralPath)shape).curveTo(26.400002, 91.7, 24.600002, 91.0, 23.2, 89.6);
((GeneralPath)shape).curveTo(21.9, 88.0, 21.2, 86.0, 21.2, 83.5);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(24.5, 83.4);
((GeneralPath)shape).curveTo(24.5, 85.200005, 24.9, 86.5, 25.7, 87.5);
((GeneralPath)shape).curveTo(26.5, 88.4, 27.6, 88.9, 28.900002, 88.9);
((GeneralPath)shape).curveTo(30.2, 88.9, 31.2, 88.4, 32.0, 87.5);
((GeneralPath)shape).curveTo(32.8, 86.6, 33.2, 85.2, 33.2, 83.4);
((GeneralPath)shape).curveTo(33.2, 81.6, 32.8, 80.200005, 32.0, 79.4);
((GeneralPath)shape).curveTo(31.2, 78.5, 30.1, 78.1, 28.8, 78.1);
((GeneralPath)shape).curveTo(27.499998, 78.1, 26.4, 78.5, 25.599998, 79.4);
((GeneralPath)shape).curveTo(24.9, 80.2, 24.5, 81.6, 24.5, 83.4);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(42.6, 91.3);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(51.0, 91.3);
((GeneralPath)shape).lineTo(56.4, 83.100006);
((GeneralPath)shape).lineTo(51.5, 75.600006);
((GeneralPath)shape).lineTo(55.2, 75.600006);
((GeneralPath)shape).lineTo(58.4, 80.700005);
((GeneralPath)shape).lineTo(61.5, 75.600006);
((GeneralPath)shape).lineTo(65.2, 75.600006);
((GeneralPath)shape).lineTo(60.299995, 83.200005);
((GeneralPath)shape).lineTo(65.7, 91.3);
((GeneralPath)shape).lineTo(61.799995, 91.3);
((GeneralPath)shape).lineTo(58.299995, 85.9);
((GeneralPath)shape).lineTo(54.799995, 91.3);
((GeneralPath)shape).lineTo(51.0, 91.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_potx of(int width, int height) {
       ext_potx result = new ext_potx();
       result.width = width;

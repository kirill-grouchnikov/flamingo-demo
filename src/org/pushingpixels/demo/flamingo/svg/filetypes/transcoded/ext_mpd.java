 ...
 */
public class ext_mpd implements
...
((GeneralPath)shape).lineTo(30.5, 91.100006);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(34.5, 74.59999);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_mpd of(int width, int height) {
       ext_mpd result = new ext_mpd();
       result.width = width;

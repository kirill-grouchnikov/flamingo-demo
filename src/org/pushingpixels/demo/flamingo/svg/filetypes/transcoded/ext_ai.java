 ...
 */
public class ext_ai implements
...
((GeneralPath)shape).lineTo(37.1, 86.6);
((GeneralPath)shape).lineTo(29.0, 86.6);
((GeneralPath)shape).lineTo(27.3, 91.1);
((GeneralPath)shape).lineTo(23.0, 91.1);
((GeneralPath)shape).lineTo(30.9, 71.3);
((GeneralPath)shape).lineTo(35.2, 71.3);
((GeneralPath)shape).lineTo(43.3, 91.1);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(35.8, 83.2);
((GeneralPath)shape).lineTo(33.0, 75.9);
((GeneralPath)shape).lineTo(30.3, 83.3);
((GeneralPath)shape).lineTo(35.8, 83.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(45.3, 91.1);
((GeneralPath)shape).lineTo(45.3, 71.2);
((GeneralPath)shape).lineTo(49.399998, 71.2);
((GeneralPath)shape).lineTo(49.399998, 91.0);
((GeneralPath)shape).lineTo(45.3, 91.0);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_ai of(int width, int height) {
       ext_ai result = new ext_ai();
       result.width = width;

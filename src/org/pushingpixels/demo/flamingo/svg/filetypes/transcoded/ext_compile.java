 ...
 */
public class ext_compile implements
...
((GeneralPath)shape).curveTo(10.999999, 87.3, 11.2, 86.8, 11.4, 86.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).curveTo(22.2, 89.5, 21.0, 90.0, 19.5, 90.0);
((GeneralPath)shape).curveTo(18.0, 90.0, 16.8, 89.5, 15.9, 88.6);
((GeneralPath)shape).curveTo(15.1, 87.7, 14.7, 86.4, 14.7, 84.9);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(17.0, 82.8, 16.7, 83.6, 16.7, 84.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(76, 108, 123, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(25.9, 89.8);
((GeneralPath)shape).lineTo(25.9, 79.8);
((GeneralPath)shape).lineTo(28.9, 79.8);
((GeneralPath)shape).lineTo(30.699999, 86.600006);
...
paint = new Color(76, 108, 123, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(37.6, 89.8);
((GeneralPath)shape).lineTo(37.6, 79.8);
((GeneralPath)shape).lineTo(40.8, 79.8);
((GeneralPath)shape).curveTo(42.0, 79.8, 42.8, 79.8, 43.2, 80.0);
((GeneralPath)shape).curveTo(43.8, 80.2, 44.3, 80.5, 44.600002, 81.0);
((GeneralPath)shape).curveTo(45.000004, 81.5, 45.2, 82.2, 45.2, 83.0);
((GeneralPath)shape).curveTo(45.2, 83.6, 45.100002, 84.1, 44.9, 84.6);
((GeneralPath)shape).curveTo(44.7, 85.0, 44.4, 85.299995, 44.0, 85.6);
((GeneralPath)shape).curveTo(43.7, 85.799995, 43.3, 86.0, 43.0, 86.1);
((GeneralPath)shape).curveTo(42.6, 86.0, 41.9, 86.0, 41.0, 86.0);
((GeneralPath)shape).lineTo(39.7, 86.0);
((GeneralPath)shape).lineTo(39.7, 89.8);
((GeneralPath)shape).lineTo(37.6, 89.8);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(39.6, 81.5);
((GeneralPath)shape).lineTo(39.6, 84.3);
((GeneralPath)shape).lineTo(40.699997, 84.3);
((GeneralPath)shape).curveTo(41.499996, 84.3, 41.999996, 84.200005, 42.299995, 84.100006);
((GeneralPath)shape).curveTo(42.599995, 84.00001, 42.799995, 83.8, 42.899994, 83.600006);
((GeneralPath)shape).curveTo(43.099995, 83.40001, 43.099995, 83.100006, 43.099995, 82.8);
((GeneralPath)shape).curveTo(43.099995, 82.4, 42.999996, 82.100006, 42.799995, 81.9);
((GeneralPath)shape).curveTo(42.599995, 81.700005, 42.299995, 81.5, 41.999996, 81.5);
((GeneralPath)shape).curveTo(41.799995, 81.5, 41.299995, 81.4, 40.499996, 81.4);
((GeneralPath)shape).lineTo(39.6, 81.4);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(50.9, 89.9);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_compile of(int width, int height) {
       ext_compile result = new ext_compile();
       result.width = width;

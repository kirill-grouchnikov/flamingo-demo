 ...
 */
public class ext_aa implements
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(36.7, 91.2);
((GeneralPath)shape).lineTo(32.3, 91.2);
((GeneralPath)shape).lineTo(30.5, 86.7);
((GeneralPath)shape).lineTo(22.5, 86.7);
((GeneralPath)shape).lineTo(20.8, 91.2);
((GeneralPath)shape).lineTo(16.5, 91.2);
((GeneralPath)shape).lineTo(24.3, 71.299995);
((GeneralPath)shape).lineTo(28.599998, 71.299995);
((GeneralPath)shape).lineTo(36.7, 91.2);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(29.2, 83.3);
((GeneralPath)shape).lineTo(26.400002, 75.9);
((GeneralPath)shape).lineTo(23.7, 83.3);
((GeneralPath)shape).lineTo(29.2, 83.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_aa of(int width, int height) {
       ext_aa result = new ext_aa();
       result.width = width;

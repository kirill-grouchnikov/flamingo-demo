 ...
 */
public class ext_adn implements
...
((GeneralPath)shape).lineTo(28.000004, 90.99999);
((GeneralPath)shape).lineTo(28.000004, 71.2);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(32.3, 74.7);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_adn of(int width, int height) {
       ext_adn result = new ext_adn();
       result.width = width;

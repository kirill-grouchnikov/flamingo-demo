 ...
 */
public class ext_dot implements
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(12.3, 74.6);
((GeneralPath)shape).lineTo(12.3, 87.7);
((GeneralPath)shape).lineTo(15.3, 87.7);
((GeneralPath)shape).curveTo(16.4, 87.7, 17.2, 87.6, 17.7, 87.5);
((GeneralPath)shape).curveTo(18.400002, 87.3, 18.900002, 87.1, 19.300001, 86.7);
((GeneralPath)shape).curveTo(19.7, 86.299995, 20.1, 85.7, 20.400002, 84.799995);
((GeneralPath)shape).curveTo(20.700003, 83.899994, 20.800001, 82.7, 20.800001, 81.2);
((GeneralPath)shape).curveTo(20.800001, 79.7, 20.7, 78.5, 20.400002, 77.7);
((GeneralPath)shape).curveTo(20.100002, 76.899994, 19.7, 76.2, 19.300001, 75.799995);
((GeneralPath)shape).curveTo(18.900002, 75.399994, 18.2, 74.99999, 17.400002, 74.899994);
((GeneralPath)shape).curveTo(16.800001, 74.799995, 15.700002, 74.7, 14.100001, 74.7);
((GeneralPath)shape).lineTo(12.3, 74.7);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(27.7, 81.3);
((GeneralPath)shape).curveTo(27.7, 79.3, 28.0, 77.600006, 28.6, 76.200005);
((GeneralPath)shape).curveTo(29.1, 75.200005, 29.7, 74.3, 30.5, 73.50001);
((GeneralPath)shape).curveTo(31.3, 72.700005, 32.2, 72.100006, 33.1, 71.700005);
((GeneralPath)shape).curveTo(34.3, 71.200005, 35.8, 70.9, 37.399998, 70.9);
((GeneralPath)shape).curveTo(40.399998, 70.9, 42.699997, 71.8, 44.499996, 73.6);
((GeneralPath)shape).curveTo(46.299995, 75.4, 47.199997, 77.9, 47.199997, 81.2);
((GeneralPath)shape).curveTo(47.199997, 84.399994, 46.299995, 86.899994, 44.6, 88.7);
((GeneralPath)shape).curveTo(42.9, 90.5, 40.5, 91.399994, 37.5, 91.399994);
((GeneralPath)shape).curveTo(34.5, 91.399994, 32.1, 90.49999, 30.4, 88.7);
((GeneralPath)shape).curveTo(28.5, 86.9, 27.7, 84.4, 27.7, 81.3);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(32.3, 77.1, 31.8, 78.8, 31.8, 81.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(54.8, 91.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_dot of(int width, int height) {
       ext_dot result = new ext_dot();
       result.width = width;

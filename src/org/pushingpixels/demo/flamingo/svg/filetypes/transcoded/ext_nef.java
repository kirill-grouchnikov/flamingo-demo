 ...
 */
public class ext_nef implements
...
((GeneralPath)shape).lineTo(45.7, 91.00001);
((GeneralPath)shape).lineTo(30.5, 91.00001);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_nef of(int width, int height) {
       ext_nef result = new ext_nef();
       result.width = width;

 ...
 */
public class ext_py implements
...
((GeneralPath)shape).lineTo(43.3, 90.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).curveTo(46.2, 18.6, 38.6, 18.6, 38.6, 18.6);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(26.4, 25.5);
((GeneralPath)shape).curveTo(25.6, 25.5, 25.0, 24.9, 25.0, 24.1);
((GeneralPath)shape).curveTo(25.0, 23.300001, 25.6, 22.7, 26.4, 22.7);
((GeneralPath)shape).curveTo(27.199999, 22.7, 27.8, 23.300001, 27.8, 24.1);
((GeneralPath)shape).curveTo(27.9, 24.8, 27.2, 25.5, 26.4, 25.5);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(47.3, 35.4);
((GeneralPath)shape).curveTo(47.3, 40.7, 39.7, 40.7, 39.7, 40.7);
((GeneralPath)shape).lineTo(32.2, 40.7);
((GeneralPath)shape).curveTo(24.6, 40.7, 24.6, 46.0, 24.6, 46.0);
((GeneralPath)shape).lineTo(24.6, 56.7);
((GeneralPath)shape).curveTo(24.6, 62.0, 32.2, 62.0, 32.2, 62.0);
((GeneralPath)shape).lineTo(39.8, 62.0);
((GeneralPath)shape).curveTo(47.399998, 62.0, 47.399998, 56.7, 47.399998, 56.7);
((GeneralPath)shape).lineTo(47.399998, 53.4);
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(44.3, 55.1);
((GeneralPath)shape).curveTo(45.1, 55.1, 45.7, 55.699997, 45.7, 56.5);
((GeneralPath)shape).curveTo(45.7, 57.300003, 45.100002, 57.9, 44.3, 57.9);
((GeneralPath)shape).curveTo(43.499996, 57.9, 42.899998, 57.300003, 42.899998, 56.5);
((GeneralPath)shape).curveTo(42.899998, 55.699997, 43.5, 55.1, 44.3, 55.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_py of(int width, int height) {
       ext_py result = new ext_py();
       result.width = width;

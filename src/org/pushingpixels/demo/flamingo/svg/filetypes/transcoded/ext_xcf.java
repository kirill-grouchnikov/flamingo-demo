 ...
 */
public class ext_xcf implements
...
((GeneralPath)shape).lineTo(8.900001, 71.2);
((GeneralPath)shape).lineTo(13.6, 71.2);
((GeneralPath)shape).lineTo(17.6, 77.6);
((GeneralPath)shape).lineTo(21.5, 71.2);
((GeneralPath)shape).lineTo(26.2, 71.2);
((GeneralPath)shape).lineTo(20.0, 80.9);
((GeneralPath)shape).lineTo(26.8, 91.1);
((GeneralPath)shape).lineTo(22.0, 91.1);
((GeneralPath)shape).lineTo(17.6, 84.2);
((GeneralPath)shape).lineTo(13.200001, 91.1);
((GeneralPath)shape).lineTo(8.3, 91.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(41.7, 83.8);
((GeneralPath)shape).lineTo(45.600002, 85.0);
((GeneralPath)shape).curveTo(45.000004, 87.2, 44.000004, 88.8, 42.600002, 89.8);
((GeneralPath)shape).curveTo(41.2, 90.8, 39.4, 91.4, 37.300003, 91.4);
((GeneralPath)shape).curveTo(34.600002, 91.4, 32.500004, 90.5, 30.800003, 88.700005);
((GeneralPath)shape).curveTo(29.100002, 86.90001, 28.200003, 84.4, 28.200003, 81.3);
((GeneralPath)shape).curveTo(28.200003, 78.0, 29.100002, 75.4, 30.800003, 73.600006);
((GeneralPath)shape).curveTo(32.500004, 71.80001, 34.800003, 70.90001, 37.600002, 70.90001);
((GeneralPath)shape).curveTo(40.000004, 70.90001, 42.000004, 71.600006, 43.600002, 73.100006);
((GeneralPath)shape).curveTo(44.500004, 73.90001, 45.2, 75.200005, 45.600002, 76.8);
((GeneralPath)shape).lineTo(41.600002, 77.700005);
((GeneralPath)shape).curveTo(41.4, 76.700005, 40.9, 75.9, 40.100002, 75.3);
((GeneralPath)shape).curveTo(39.300003, 74.700005, 38.4, 74.4, 37.4, 74.4);
((GeneralPath)shape).curveTo(35.9, 74.4, 34.7, 74.9, 33.800003, 76.0);
((GeneralPath)shape).curveTo(32.900005, 77.1, 32.4, 78.8, 32.4, 81.1);
((GeneralPath)shape).curveTo(32.4, 83.6, 32.9, 85.4, 33.800003, 86.5);
((GeneralPath)shape).curveTo(34.700005, 87.6, 35.9, 88.1, 37.300003, 88.1);
((GeneralPath)shape).curveTo(38.4, 88.1, 39.300003, 87.799995, 40.100002, 87.1);
((GeneralPath)shape).curveTo(40.8, 86.3, 41.4, 85.2, 41.7, 83.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_xcf of(int width, int height) {
       ext_xcf result = new ext_xcf();
       result.width = width;

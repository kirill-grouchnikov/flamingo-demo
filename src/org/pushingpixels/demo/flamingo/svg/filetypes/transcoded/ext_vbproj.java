 ...
 */
public class ext_vbproj implements
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(8.8, 89.8);
((GeneralPath)shape).lineTo(4.9, 79.1);
((GeneralPath)shape).lineTo(7.3, 79.1);
((GeneralPath)shape).lineTo(10.0, 87.0);
((GeneralPath)shape).lineTo(12.7, 79.1);
((GeneralPath)shape).lineTo(15.0, 79.1);
((GeneralPath)shape).lineTo(11.1, 89.799995);
((GeneralPath)shape).lineTo(8.8, 89.799995);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(76, 108, 123, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(16.1, 79.1);
((GeneralPath)shape).lineTo(20.400002, 79.1);
((GeneralPath)shape).curveTo(21.300001, 79.1, 21.900002, 79.1, 22.300001, 79.2);
((GeneralPath)shape).curveTo(22.7, 79.299995, 23.1, 79.399994, 23.400002, 79.6);
((GeneralPath)shape).curveTo(23.700003, 79.8, 24.000002, 80.1, 24.2, 80.5);
((GeneralPath)shape).curveTo(24.400002, 80.9, 24.5, 81.3, 24.5, 81.8);
((GeneralPath)shape).curveTo(24.5, 82.3, 24.4, 82.8, 24.1, 83.200005);
((GeneralPath)shape).curveTo(23.800001, 83.600006, 23.5, 83.9, 23.0, 84.100006);
((GeneralPath)shape).curveTo(23.7, 84.3, 24.2, 84.600006, 24.5, 85.100006);
((GeneralPath)shape).curveTo(24.9, 85.600006, 25.0, 86.100006, 25.0, 86.700005);
((GeneralPath)shape).curveTo(25.0, 87.200005, 24.9, 87.700005, 24.7, 88.100006);
((GeneralPath)shape).curveTo(24.5, 88.600006, 24.2, 88.90001, 23.800001, 89.200005);
((GeneralPath)shape).curveTo(23.400002, 89.50001, 22.900002, 89.600006, 22.300001, 89.700005);
((GeneralPath)shape).curveTo(21.900002, 89.700005, 21.1, 89.8, 19.7, 89.8);
((GeneralPath)shape).lineTo(16.0, 89.8);
((GeneralPath)shape).lineTo(16.0, 79.1);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(18.3, 80.9);
((GeneralPath)shape).lineTo(18.3, 83.4);
((GeneralPath)shape).lineTo(19.699999, 83.4);
((GeneralPath)shape).curveTo(20.599998, 83.4, 21.099998, 83.4, 21.3, 83.4);
((GeneralPath)shape).curveTo(21.699999, 83.4, 22.0, 83.200005, 22.199999, 83.0);
((GeneralPath)shape).curveTo(22.4, 82.8, 22.499998, 82.5, 22.499998, 82.2);
((GeneralPath)shape).curveTo(22.499998, 81.899994, 22.399998, 81.6, 22.199999, 81.399994);
((GeneralPath)shape).curveTo(21.999998, 81.2, 21.699999, 81.09999, 21.4, 80.99999);
((GeneralPath)shape).curveTo(21.199999, 80.99999, 20.6, 80.99999, 19.5, 80.99999);
((GeneralPath)shape).lineTo(18.3, 80.99999);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(18.3, 85.1);
((GeneralPath)shape).lineTo(18.3, 88.0);
((GeneralPath)shape).lineTo(20.3, 88.0);
((GeneralPath)shape).curveTo(21.099998, 88.0, 21.599998, 88.0, 21.8, 87.9);
((GeneralPath)shape).curveTo(22.099998, 87.8, 22.4, 87.700005, 22.599998, 87.5);
((GeneralPath)shape).curveTo(22.8, 87.3, 22.899998, 87.0, 22.899998, 86.6);
((GeneralPath)shape).curveTo(22.899998, 86.299995, 22.799997, 86.0, 22.699997, 85.799995);
((GeneralPath)shape).curveTo(22.499996, 85.6, 22.299997, 85.399994, 21.999996, 85.299995);
((GeneralPath)shape).curveTo(21.699997, 85.2, 21.099997, 85.1, 20.099997, 85.1);
((GeneralPath)shape).lineTo(18.3, 85.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_vbproj of(int width, int height) {
       ext_vbproj result = new ext_vbproj();
       result.width = width;

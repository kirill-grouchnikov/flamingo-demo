 ...
 */
public class ext_ovf implements
...
((GeneralPath)shape).curveTo(9.0, 87.9, 8.1, 85.4, 8.1, 82.3);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(12.2, 82.1);
((GeneralPath)shape).curveTo(12.2, 84.299995, 12.7, 86.1, 13.8, 87.2);
((GeneralPath)shape).curveTo(14.8, 88.399994, 16.2, 88.899994, 17.8, 88.899994);
((GeneralPath)shape).curveTo(19.399998, 88.899994, 20.699999, 88.299995, 21.8, 87.2);
((GeneralPath)shape).curveTo(22.8, 86.0, 23.4, 84.299995, 23.4, 82.0);
((GeneralPath)shape).curveTo(23.4, 79.7, 22.9, 78.0, 21.9, 76.9);
((GeneralPath)shape).curveTo(20.9, 75.8, 19.6, 75.200005, 17.9, 75.200005);
((GeneralPath)shape).curveTo(16.199999, 75.200005, 14.9, 75.8, 13.9, 76.9);
((GeneralPath)shape).curveTo(12.8, 78.1, 12.2, 79.8, 12.2, 82.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(160, 120, 2, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(35.8, 92.1);
((GeneralPath)shape).lineTo(28.599998, 72.3);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_ovf of(int width, int height) {
       ext_ovf result = new ext_ovf();
       result.width = width;

 ...
 */
public class ext_aif implements
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(33.9, 91.2);
((GeneralPath)shape).lineTo(29.500002, 91.2);
((GeneralPath)shape).lineTo(27.700003, 86.7);
((GeneralPath)shape).lineTo(19.700003, 86.7);
((GeneralPath)shape).lineTo(18.0, 91.2);
((GeneralPath)shape).lineTo(13.7, 91.2);
((GeneralPath)shape).lineTo(21.5, 71.299995);
((GeneralPath)shape).lineTo(25.8, 71.299995);
((GeneralPath)shape).lineTo(33.9, 91.2);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(26.4, 83.3);
((GeneralPath)shape).lineTo(23.6, 75.9);
((GeneralPath)shape).lineTo(20.9, 83.3);
((GeneralPath)shape).lineTo(26.4, 83.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(43.9, 91.2);
((GeneralPath)shape).lineTo(43.9, 71.3);
((GeneralPath)shape).lineTo(57.7, 71.3);
((GeneralPath)shape).lineTo(57.7, 74.700005);
((GeneralPath)shape).lineTo(48.0, 74.700005);
((GeneralPath)shape).lineTo(48.0, 79.4);
((GeneralPath)shape).lineTo(56.4, 79.4);
((GeneralPath)shape).lineTo(56.4, 82.8);
((GeneralPath)shape).lineTo(48.0, 82.8);
((GeneralPath)shape).lineTo(48.0, 91.3);
((GeneralPath)shape).lineTo(43.9, 91.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_aif of(int width, int height) {
       ext_aif result = new ext_aif();
       result.width = width;

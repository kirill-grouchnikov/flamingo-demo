 ...
 */
public class ext_ps implements
...
((GeneralPath)shape).curveTo(38.9, 88.5, 38.0, 86.8, 37.8, 84.6);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_ps of(int width, int height) {
       ext_ps result = new ext_ps();
       result.width = width;

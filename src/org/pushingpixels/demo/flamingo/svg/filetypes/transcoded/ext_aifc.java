 ...
 */
public class ext_aifc implements
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(16.2, 83.3);
((GeneralPath)shape).lineTo(13.400001, 75.9);
((GeneralPath)shape).lineTo(10.700001, 83.3);
((GeneralPath)shape).lineTo(16.2, 83.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(25.8, 91.2);
((GeneralPath)shape).lineTo(25.8, 71.3);
((GeneralPath)shape).lineTo(29.9, 71.3);
((GeneralPath)shape).lineTo(29.9, 91.200005);
((GeneralPath)shape).lineTo(25.8, 91.200005);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(33.7, 91.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(63.7, 83.9);
((GeneralPath)shape).lineTo(67.6, 85.1);
((GeneralPath)shape).curveTo(67.0, 87.299995, 66.0, 88.9, 64.6, 89.9);
((GeneralPath)shape).curveTo(63.199997, 90.9, 61.399998, 91.5, 59.3, 91.5);
((GeneralPath)shape).curveTo(56.6, 91.5, 54.399998, 90.6, 52.7, 88.8);
((GeneralPath)shape).curveTo(51.0, 87.0, 50.100002, 84.5, 50.100002, 81.4);
((GeneralPath)shape).curveTo(50.100002, 78.1, 51.000004, 75.5, 52.7, 73.700005);
((GeneralPath)shape).curveTo(54.4, 71.9, 56.7, 71.00001, 59.5, 71.00001);
((GeneralPath)shape).curveTo(62.0, 71.00001, 64.0, 71.700005, 65.5, 73.200005);
((GeneralPath)shape).curveTo(66.4, 74.100006, 67.1, 75.3, 67.6, 76.9);
((GeneralPath)shape).lineTo(63.6, 77.9);
((GeneralPath)shape).curveTo(63.399998, 76.9, 62.899998, 76.1, 62.1, 75.5);
((GeneralPath)shape).curveTo(61.3, 74.9, 60.399998, 74.6, 59.3, 74.6);
((GeneralPath)shape).curveTo(57.8, 74.6, 56.6, 75.1, 55.7, 76.2);
((GeneralPath)shape).curveTo(54.8, 77.299995, 54.3, 79.0, 54.3, 81.299995);
((GeneralPath)shape).curveTo(54.3, 83.799995, 54.8, 85.6, 55.7, 86.7);
((GeneralPath)shape).curveTo(56.600002, 87.799995, 57.8, 88.299995, 59.3, 88.299995);
((GeneralPath)shape).curveTo(60.399998, 88.299995, 61.3, 87.99999, 62.1, 87.299995);
((GeneralPath)shape).curveTo(62.8, 86.4, 63.4, 85.3, 63.7, 83.9);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_aifc of(int width, int height) {
       ext_aifc result = new ext_aifc();
       result.width = width;

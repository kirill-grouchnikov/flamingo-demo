 ...
 */
public class ext_pst implements
...
((GeneralPath)shape).lineTo(10.4, 91.100006);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(29.1, 88.5, 28.3, 86.8, 28.0, 84.6);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(52.2, 91.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_pst of(int width, int height) {
       ext_pst result = new ext_pst();
       result.width = width;

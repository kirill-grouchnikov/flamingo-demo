 ...
 */
public class ext_exe implements
...
((GeneralPath)shape).lineTo(25.0, 91.00001);
((GeneralPath)shape).lineTo(9.8, 91.00001);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(76, 108, 123, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(26.4, 91.1);
...
((GeneralPath)shape).lineTo(26.4, 91.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(76, 108, 123, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(47.1, 91.1);
((GeneralPath)shape).lineTo(47.1, 71.2);
((GeneralPath)shape).lineTo(61.899998, 71.2);
((GeneralPath)shape).lineTo(61.899998, 74.6);
...
((GeneralPath)shape).lineTo(62.3, 91.00001);
((GeneralPath)shape).lineTo(47.1, 91.00001);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).curveTo(55.3, 38.3, 55.3, 37.3, 55.1, 36.3);
((GeneralPath)shape).closePath();
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_exe of(int width, int height) {
       ext_exe result = new ext_exe();
       result.width = width;

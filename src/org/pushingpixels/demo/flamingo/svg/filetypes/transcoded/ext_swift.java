 ...
 */
public class ext_swift implements
...
((GeneralPath)shape).curveTo(17.199999, 24.3, 17.5, 24.3, 17.8, 24.3);
...
((GeneralPath)shape).curveTo(28.599998, 23.299997, 28.9, 23.299997, 29.3, 23.299997);
...
((GeneralPath)shape).curveTo(52.5, 61.0, 36.3, 44.3, 34.9, 43.1);
...
((GeneralPath)shape).lineTo(14.0, 24.2);
((GeneralPath)shape).lineTo(15.4, 24.5);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).curveTo(36.900005, 28.800005, 37.000004, 28.800005, 37.100006, 28.800005);
...
((GeneralPath)shape).lineTo(15.3, 26.0);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(30.000002, 91.3);
((GeneralPath)shape).lineTo(27.100002, 80.600006);
((GeneralPath)shape).lineTo(24.200003, 91.3);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(38.1, 91.3);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(43.8, 91.3);
...
((GeneralPath)shape).lineTo(43.8, 91.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new Color(255, 255, 255, 255);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(59.3, 91.3);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ext_swift of(int width, int height) {
       ext_swift result = new ext_swift();
       result.width = width;
